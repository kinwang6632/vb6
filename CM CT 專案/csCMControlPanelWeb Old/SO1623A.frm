...
Private Sub GrdFmt(ByRef rsLog As Object)
  On Error GoTo ChkErr
    ...
    With mFlds
            ...
            .Add "EXECDATE", , , , , "執行日期", vbLeftJustify
...
'                            If Not ACSAccPWS(rsData, strResult, strFaultReason, strErrMsg, rsResult) Then GoTo ErrTran
                        ...
                        Case optCMChange(8)
                            ...
                            Else
                                If Not OpenCM(rsData, GetPCMac, lngInstAddrNo, GetClassID(gilBP.GetCodeNo), GetDynaIP, strResult, strFaultReason, strErrMsg, rsResult) Then GoTo ErrTran
                            End If
                    End Select
                Case 2
                    Select Case True
...
'        If chkSetAll = 1 Then Call OpenData2
        ...
        Me.Enabled = True
        If blnShowXML Then Show_XML_Result rsResult
...
'        GetClassID = GetRsValue("SELECT " & strClassIdFld & " FROM " & GetOwner & "CD064 WHERE CODENO = " & rsData("CMBaudNo"))
        ...
        Else
            GetClassID = GetRsValue("SELECT " & strClassIdFld & " FROM " & GetOwner & "CD078D WHERE BPCODE = '" & strBPcode & "'")
        End If
...
Private Sub ggrQuery_ShowCellData(ByVal Col As Long, ByVal Row As Long, ByVal giFld As prjGiGridR.GiGridFld, ByVal Fld As ADODB.Field, Value As Variant)
    If giFld.FieldName = "ModeType" Then
...
Private Sub optBasic_Click(Index As Integer)
  On Error Resume Next
    Select Case Index
                Case 0
                    If optBasic(0).Value Then chkAccStop.Value = 0
                Case 1
                    If optBasic(1).Value Then ChkAccStart.Value = 0
    End Select
End Sub
