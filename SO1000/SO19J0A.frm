...
Begin VB.Form frmSO19J0A 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(6)=   "ggrData"
      Tab(0).Control(7)=   "lblEditMode"
      ...
      Begin TabDlg.SSTab SSTab3 
         ...
         Tab(2).Control(0)=   "cmdSelectPath3"
         Tab(2).Control(1)=   "txtExportPath3"
         Tab(2).Control(2)=   "cmdCancel4"
         Tab(2).Control(3)=   "cmdExport3"
         Tab(2).Control(4)=   "txtExportFile3"
         Tab(2).Control(5)=   "gimPrCode1"
         Tab(2).Control(6)=   "GiPrDate2"
         Tab(2).Control(7)=   "GiPrDate1"
         Tab(2).Control(8)=   "GiExportRefDate1"
         Tab(2).Control(9)=   "GiExportDate4"
         Tab(2).Control(10)=   "gimReasonCode"
         Tab(2).Control(11)=   "lblExportFile3"
         Tab(2).Control(12)=   "Label35"
         Tab(2).Control(13)=   "Label34"
         Tab(2).Control(14)=   "Label33"
         Tab(2).Control(15)=   "Label32"
         Tab(2).Control(16)=   "Label30"
         ...
         TabCaption(5)   =   "過期門號匯出"
         TabPicture(5)   =   "SO19J0A.frx":058D
         Tab(5).ControlEnabled=   -1  'True
         Tab(5).Control(0)=   "Label55"
         Tab(5).Control(0).Enabled=   0   'False
         Tab(5).Control(1)=   "Label56"
         Tab(5).Control(1).Enabled=   0   'False
         Tab(5).Control(2)=   "Label57"
         Tab(5).Control(2).Enabled=   0   'False
         Tab(5).Control(3)=   "Label58"
         Tab(5).Control(3).Enabled=   0   'False
         Tab(5).Control(4)=   "Label59"
         Tab(5).Control(4).Enabled=   0   'False
         Tab(5).Control(5)=   "lblExportFile6"
         Tab(5).Control(5).Enabled=   0   'False
         Tab(5).Control(6)=   "giKeepDate2"
         Tab(5).Control(6).Enabled=   0   'False
         Tab(5).Control(7)=   "giKeepDate1"
         Tab(5).Control(7).Enabled=   0   'False
         Tab(5).Control(8)=   "txtExportPath6"
         Tab(5).Control(8).Enabled=   0   'False
         Tab(5).Control(9)=   "cmdSelectPath6"
         Tab(5).Control(9).Enabled=   0   'False
         Tab(5).Control(10)=   "txtLogFile7"
         Tab(5).Control(10).Enabled=   0   'False
         Tab(5).Control(11)=   "cmdChooseFile10"
         Tab(5).Control(11).Enabled=   0   'False
         Tab(5).Control(12)=   "cmdExport6"
         Tab(5).Control(12).Enabled=   0   'False
         Tab(5).Control(13)=   "cmdCancel9"
         Tab(5).Control(13).Enabled=   0   'False
         Tab(5).Control(14)=   "txtExportFile6"
         Tab(5).Control(14).Enabled=   0   'False
         Tab(5).Control(15)=   "GiExportDate7"
         Tab(5).Control(15).Enabled=   0   'False
         Tab(5).ControlCount=   16
         Begin Gi_Date.GiDate GiExportDate7 
            Height          =   315
            Left            =   7440
            TabIndex        =   182
            Top             =   2760
            ...
            EndProperty
         End
         Begin VB.TextBox txtExportFile6 
            BeginProperty Font 
               Name            =   "新細明體"
               Size            =   9.75
               Charset         =   136
            ...
            Width           =   2955
         End
         Begin VB.CommandButton cmdCancel9 
            Caption         =   "取消"
            Height          =   375
            Left            =   6360
            TabIndex        =   179
            ...
            Width           =   1215
         End
         Begin VB.CommandButton cmdExport6 
            Caption         =   "匯出"
            Height          =   375
            Left            =   2970
            TabIndex        =   178
            ...
            Width           =   1215
         End
         Begin VB.CommandButton cmdChooseFile10 
            Caption         =   "..."
            BeginProperty Font 
               Name            =   "新細明體"
               Size            =   9.75
         ...
         Begin VB.TextBox txtLogFile7 
            ...
            Width           =   5565
         End
         Begin VB.CommandButton cmdSelectPath6 
            Caption         =   "..."
            BeginProperty Font 
               Name            =   "新細明體"
               Size            =   9.75
            ...
            Width           =   420
         End
         Begin VB.TextBox txtExportPath6 
            BeginProperty Font 
               Name            =   "新細明體"
               Size            =   9.75
               Charset         =   136
         ...
         Begin Gi_Multi.GiMulti gimUCCode 
            ...
            FontName        =   "新細明體"
         End
         Begin Gi_Date.GiDate giKeepDate1 
            Height          =   330
            Left            =   2730
            TabIndex        =   168
            Top             =   3090
            ...
            EndProperty
         End
         Begin Gi_Date.GiDate giKeepDate2 
            Height          =   330
            Left            =   4560
            TabIndex        =   169
            Top             =   3090
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         TabPicture(0)   =   "SO19J0A.frx":05A9
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "txtShouldDay"
         Tab(0).Control(1)=   "PB1"
         Tab(0).Control(2)=   "ComdPath"
         Tab(0).Control(3)=   "Frame1"
         Tab(0).Control(4)=   "cmdChooseFile2"
         Tab(0).Control(5)=   "cmdChooseFile1"
         Tab(0).Control(6)=   "cmdInport1"
         Tab(0).Control(7)=   "cmdCancel1"
         Tab(0).Control(8)=   "txtLogFile1"
         Tab(0).Control(9)=   "txtImportFile1"
         Tab(0).Control(10)=   "Label53"
         Tab(0).Control(11)=   "Label52"
         Tab(0).Control(12)=   "Label15"
         Tab(0).Control(13)=   "Label14"
         Tab(0).Control(14)=   "Label13"
         Tab(0).ControlCount=   15
         TabCaption(1)   =   "CP通話明細資料匯入"
         TabPicture(1)   =   "SO19J0A.frx":05C5
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "txtLogFile3"
         Tab(1).Control(1)=   "cmdChooseFile6"
         Tab(1).Control(2)=   "cmdCancel8"
         Tab(1).Control(3)=   "cmdInport3"
         Tab(1).Control(4)=   "Frame2"
         Tab(1).Control(5)=   "cmdChooseFile5"
         Tab(1).Control(6)=   "txtImportFile5"
         Tab(1).Control(7)=   "PB2"
         Tab(1).Control(8)=   "Label48"
         Tab(1).Control(9)=   "Label19"
         Tab(1).ControlCount=   10
         TabCaption(2)   =   "基本資料核對匯入"
         TabPicture(2)   =   "SO19J0A.frx":05E1
         Tab(2).ControlEnabled=   -1  'True
...
Private Sub cmdChooseFile10_Click()
    On Error Resume Next
    Call SelectImportLog(txtLogFile7)
End Sub
...
On Error GoTo ChkErr
'#3195 將元件的值寫入Ini檔 By Kin 2007/07/13
...
Private Sub cmdExport6_Click()
    On Error GoTo ChkErr
        Dim strKeepSQL As String
        Dim dtaRunTime As Date
        Dim rsExportXls As New ADODB.Recordset
        Dim strFileName6 As String
        '#3195 將元件的值寫入Ini檔 By Kin 2007/07/13
        Call WriteSO19J0Ini(iniPages, strIniFile, Me)
        If Not IsDataOk6 Then Exit Sub
        Screen.MousePointer = vbHourglass
        strKeepSQL = "Select CPNumber,EBTIssue,KeepDate,useflag,RETDATE From " & GetOwner & "SO049 " & _
                     "Where " & GetChoose6
        If Not GetRS(rsExportXls, strKeepSQL, gcnGi, adUseClient, adOpenKeyset, adLockPessimistic) Then Exit Sub
        '取得匯出檔名 2007/4/2 By Kin
        If Right(txtExportPath6, 1) <> "\" Then strFileName6 = txtExportPath6 & "\"
        If InStrRev(txtExportFile6, ".") = 0 Then
            strFileName6 = strFileName6 & txtExportFile6 & ".XLS"
        End If
'        Set strmTextFile1 = FSO.CreateTextFile(txtExportPath6.Text & "\" & lblExportFile6.Caption, True)
        If Fso.FileExists(strFileName6) Then
            Fso.DeleteFile strFileName6
        End If
        If rsExportXls.RecordCount <= 0 Then
            MsgBox "無資料!!", vbInformation, "警告訊息"
            Screen.MousePointer = vbDefault
            Exit Sub
        End If
        dtaRunTime = Now
        '匯出Excel
        If Not ExportKeepDateXls(strFileName6, rsExportXls, dtaRunTime) Then
            Screen.MousePointer = vbDefault
            Exit Sub
        End If
        WriteToLog6 IIf(Right(txtExportPath6, 1) = "\", txtExportPath6 & txtLogFile7, txtExportPath6 & "\" & txtLogFile7), rsExportXls.RecordCount, dtaRunTime
        Screen.MousePointer = vbDefault
        MsgBox "匯出完成  " & vbCrLf & _
               "匯出筆數：" & rsExportXls.RecordCount & "筆", vbInformation, "匯出完成"
        CloseRecordset rsExportXls
    Exit Sub
ChkErr:
    Call ErrSub(Me.Name, "cmdExport6_Click")
End Sub
        ...
        Select Case Left(vElement, 1)
            ...
            Case "M"
                ...
                Else
                    ...
                    strBillNo = ""
                    '***********************************************************************************************************
                    '#3526 增加判斷收集年月是否正確 By Kin 2007/09/17
                    If IsDate(Left(strShouldDate, 4) & "/" & Mid(strShouldDate, 5, 2) & "/01") Then
                        blnGoOn = True
                    Else
                        Call LogError1(lngMasterErrorCount, "客編收集年月不正確：" & strCustId, "", lngLineNumber, vElement)
                        blnGoOn = False
                    End If
                    '***********************************************************************************************************
                '底下進行各式各樣的檢核
                    ...
                    If blnGoOn Then
                        ...
                        '#3303 增加判斷SO004.InstDate是否有值，如果無值要寫入Log檔 By Kin 2007/10/16
                        ...
                        Else
                            If rsTemp("InstDate") & "" = "" Then
                                blnGoOn = False
                                Call LogError1(lngMasterErrorCount, "門號：" & strString1 & " 尚未安裝完工，請完工後，再重新匯入", "", lngLineNumber, vElement)
                            End If
                        End If
                        Set rsTemp = Nothing
                    End If
                ...
                '底下進行各式各樣的檢核
                    ...
                    If blnGoOn Then
                        ...
                        Else
                            ...
                            If rsTemp2.EOF Then
                                '#4035 只要找不到資料就出Log,不要填成0 By Kin 2008/08/14
...
'                                rsSO033Cp("BankName") = "0"
                        ...
                        '#4035 以收費地址為選項時,要以SO138的收費地址為主 By Kin 2008/08/14
...
'                            rsSO033Cp("NodeNo") = "0"
          ...
          '小計項目
                ...
                Else
                    ...
                    '***********************************************************'
                    '問題集 2722 第四點沒修改到
                    '#3047 針對#2722判斷正負項問題，再改回來，因為台固沒有正負項問題 By Kin 2007/2/8
                    If blnGoOn Then
            '            If strSign = "-" Then
            '              strString1 = "CItemCode2 As CItemCode"
            '            Else
            ...
            '*******************************************************************************************
                        ...
                        '****************************************************************************
                        '#3871 SO033也要更新InvSeqNo By Kin 2008/04/15
                        strString1 = "Select FaciSeqNo, CmCode, CmName, PtCode, " & _
                        ...
                        If Not rsTemp.EOF Then
                            ...
                            '#3871 SO033 也要更新InvSeqNo By Kin 2008/04/15
                        ...
                        Else
                            ...
                            Set rsTemp2 = gcnGi.Execute(strString1)
                            If rsTemp2.EOF Then
                                '#4035只要找不到資料就出Log,不要填成0 By Kin 2008/08/14
                                'If Not blnInDetail Then
...
'                                rsSO033("BankName") = "0"
                        ...
                        Set rsTemp = Nothing
                      '依裝機地址或收費地址，將地址填入到 SO033 的地址資料中
                      '#4035 以收費地址為選項,要以SO138的收費地址為主 By Kin 2008/08/14
                        lngTempLong = 0
                        If optEmpNo.Value Then
                          '裝機地址
                            strString1 = "Select B.ClctEn, B.ClctName, B.AddrNo, B.StrtCode, " & _
...
'                                             "And (B.CustId=A.CustId) "
                      ...
                      '填入到 SO033 的地址資料中
                        If rsTemp.EOF Then
                            '#4035 找不到資料就出Log,不要填成0 By Kin 2008/08/14
                            'If Not blnInDetail Then
...
Private Sub cmdSelectPath6_Click()
    On Error Resume Next
    Call SelectPath(txtExportPath6)
End Sub
...
'*********************************************************************
  '#3195 將元件的預設由Ini讀入 By Kin 2007/07/13
  Call ReadIniPages '將元件名稱與預設值填入物件集合中
  Call ReadSO19J0Ini(iniPages, strIniFile, Me)  '將Ini檔讀出
'*********************************************************************
  Exit Sub
ChkErr:
...
Private Sub giKeepDate2_Validate(Cancel As Boolean)
  On Error Resume Next
    If giKeepDate1.GetValue & "" <> Empty Then
        If giKeepDate1.GetValue(True) > giKeepDate2.GetValue(True) Then
            MsgBox "保管日期終止日不得小於保管起始日！", vbInformation, "警告訊息"
            Cancel = True
        End If
    End If
...
Private Sub txtExportFile6_Change()
On Error GoTo ChkErr
  Call SetExporFileName(txtExportPath6, txtExportFile6, txtLogFile7, lblExportFile6, GiExportDate7)
  Exit Sub
ChkErr:
  Call ErrSub(Me.Name, "txtExportPath6_Change")
End Sub
...
On Error GoTo ChkErr
  ...
  '行號
  strString1 = ""
  '#3703測試不OK,要多加"電子檔中第?列"字樣 By Kin 2008/04/24
  If LineNumber > 0 Then
    strString1 = "電子檔中第 " & Right("00000" & LineNumber, 5) & " 列："
  End If
    ...
    While Not rsTemp.EOF
        If (strCustId <> rsTemp("CustId") & "") Or (strFaciSNo <> rsTemp("FaciSNo") & "") Or (strTfnServiceId <> rsTemp("TfnServiceId") & "") Or (strBillNo <> rsTemp("BillNo") & "") Or (strTFNBillNo <> rsTemp("TfnBillNo") & "") Then
            '依 CustId, FaciSNo, TfnServiceId, BillNo, TfnBillNo 分組產生 Master
              If (rsTemp("ShouldAmt") - rsTemp("RealAmt")) >= 0 Then
                    ...
                    '問題集2961 原銷帳年月取至年月，變更取至年月日
                    'strRealDateMaster = Left(GiTempDate.GetValue, 6)
                    strRealDateMaster = GiTempDate.GetValue
        ...
        If (rsTemp("ShouldAmt") - rsTemp("RealAmt")) >= 0 Then
            If rsTemp("ShouldAmt") <> rsTemp("RealAmt") Then
                ...
                GiTempDate.SetValue (rsTemp("RealDate"))
                '# 3125 表身2調改對象又要改回原來的年月,但規格只提要改回表身2,表身1沒改 By Kin 2007/04/04 For Handsome
                '# 2961 表身2調改對象原本為年月，現在調為年月日
                strDetail = strDetail & Left(GiTempDate.GetValue, 6)
                'strDetail = strDetail & GiTempDate.GetValue
                ...
                Else
                    ...
                    Else
                        ...
                        While Not rsTemp2.EOF
                            ...
                            '#3188 客戶有設備序號但Log會出現找不到設備，將rsTemp2("FaciSNo") & "" = strTel改為<> By Kin 2007/04/25
                            '#3188 Kin Add Common 因為會來到此段，代表客編與設備都存在，才會來此一邏輯，所以下面的邏輯，應該是跑不進去才是，不過先保留，改為<>一定跳不進去
...
'                                Set rsTemp2 = gcnGi.Execute(strString1)
                                ...
                                Set rsTmp = gcnGi.Execute(strString1)
                                
                                '找是否有設備存在，如果存在秀出反查客編
                                If rsTmp.EOF Then
                                    Call LogError22(lngBodyErrorCount, rsTemp("TFNServiceID") & "", rsTemp("CustId") & "", strTel & "", "客戶設備找不到!", strTel & "", rsTmp("FaciSNo") & "", rsTemp("RecNo") & "")
                                Else
                                    Call LogError22(lngBodyErrorCount, rsTemp("TFNServiceID") & "", rsTemp("CustId") & "", strTel & "", "客戶設備找不到!", rsTemp("CustId") & "", rsTmp("CustId") & "", rsTemp("RecNo") & "" _
                                             , rsTmp("CustID"), rsTmp("SNO"), IIf(rsTmp("INSTDATE") <> "", Format(rsTmp("INSTDATE"), "YYYY/MM/DD"), "") _
                                             , IIf(rsTmp("PRDATE") <> "", Format(rsTmp("PRDATE"), "YYYY/MM/DD"), ""))
...
Private Sub ImportData3()
  ...
  '檢核匯入檔名
    ...
    If blnGoOn2 And blnGoOn Then
        ...
        Set rsTemp = gcnGi.Execute(strString1)
        While Not rsTemp.EOF
            strString1 = "Select * From " & strViewName1 & " " & _
    ...
    If blnGoOn2 And blnGoOn Then
        ...
        For lngIndex = 1 To lngLastLine - 1
            ...
            On Error GoTo ChkErr
            If blnGoOn Then
                '檢查SO168/SO169是否有一模一樣的資料，如果有資料則不新增資料
                '#3703 多串一個Hour_Type By Kin 2008/03/03
                strString1 = ""
                '#3703 測試不OK時發現沒有串Owner By Kin 2008/04/23
                ...
                '#3703 測試不OK時發現GetRs傳入的引數不正確 By Kin 2008/04/23
    ...
    gcnGi.CommitTrans
    '***************************************************************************************************
    '#3703 如果資料有重複要Show出文字檔 By Kin 2008/03/03
    '#3703 如果選擇清除後再重新匯入,才Show出警告,如果選擇否,則不Show出任何訊息 By Kin 2008/04/23
    '#3703 測試不OK,有錯誤要多增加"新增筆數" By Kin 2008/04/24
    If Not blnNoImport Then
        If lngErrorCount > 0 Or lngUpdateCount > 0 Then
            strString1 = "文字檔筆數：" & lngLastLine - 1 & vbCrLf & _
                         ...
                         "核對錯誤/問題數：" & lngErrorCount + lngUpdateCount & vbCrLf & vbCrLf & _
...
Private Sub txtLogFile7_Change()
    On Error Resume Next
    If Fso.GetParentFolderName(txtLogFile7) <> Empty Then
        txtLogFile7 = Fso.GetFileName(txtLogFile7)
    End If
End Sub
...
End Sub
Function IsDataOk6() As Boolean
    On Error GoTo ChkErr
        Dim rsChkMode As New ADODB.Recordset
        IsDataOk6 = False
        '#3095 檢查是否為台固模式0:台固 1:亞太 By Kin 2007/3/15
        If Not GetRS(rsChkMode, "Select CPIMPORTMODE From " & GetOwner & "SO041") Then Exit Function
        If rsChkMode(0) = 1 Then
            MsgBox "此功能只適合台固門號模式使用", vbInformation, "警告訊息"
            CloseRecordset rsChkMode
            Exit Function
        End If
        '#3095 檢查輸入資料的合法性 By Kin 2007/3/15
        If giKeepDate1.GetValue & "" = "" Then
            MsgBox "請輸入保管起始日期", vbInformation, "警告訊息"
            giKeepDate1.SetFocus
            Exit Function
        End If
        If giKeepDate2.GetValue & "" = "" Then
            MsgBox "請輸入保管終止日期", vbInformation, "警告訊息"
            giKeepDate2.SetFocus
            Exit Function
        End If
        If giKeepDate1.GetValue > giKeepDate2.GetValue Then
            MsgBox "起始日期不得大於於止日期", vbInformation, "警告訊息"
            giKeepDate1.SetFocus
            Exit Function
        End If
        If txtExportFile6 & "" = "" Then
            MsgBox "請輸入匯出檔名", vbInformation, "警告訊息"
            txtExportFile6.SetFocus
            Exit Function
        '#3095 檢查副檔名是否為Excel格式
        Else
            If InStrRev(txtExportFile6, ".") > 0 Then
                If UCase(Mid(txtExportFile6, InStrRev(txtExportFile6, ".") + 1)) <> "XLS" Then
                    MsgBox "匯出檔案必須為Excel格式", vbInformation, "警告訊息"
                    txtExportFile6.SetFocus
                    Exit Function
                End If
            End If
        ...
        If txtExportPath6 = "" Then
            MsgBox "請輸入匯出路徑", vbInformation, "警告訊息"
            cmdSelectPath6.SetFocus
            Exit Function
        End If
        If txtLogFile7 = "" Then
            MsgBox "請輸入問題記錄檔", vbInformation, "警告訊息"
            cmdChooseFile10.SetFocus
            Exit Function
        End If
        CloseRecordset rsChkMode
        IsDataOk6 = True
    Exit Function
ChkErr:
    Call ErrSub(Me.Name, "IsDataOk6")
End Function
'#3095 將資料匯出Excel By Kin 2007/03/21 Add
Private Function ExportKeepDateXls(ByVal strFile As String, rs As Recordset, ByVal dtaWriteRcd As Date) As Boolean
  On Error GoTo ChkErr
    Dim objXls As Object
    Dim varFldName As Variant
    Dim varFldWidth As Variant
    Dim intLoop As Long
    ExportKeepDateXls = False
    varFldName = Array("PowerHammer", "門號", "匯入日期", "保管到期日", "使用狀態")
    varFldWidth = Array(38, 13, 13, 25, 10)
    ...
    With objXls
        ...
        '指定欄位名稱
         For intLoop = 1 To UBound(varFldName)
            .ActiveSheet.Cells(1, intLoop).Value = varFldName(intLoop)
            .ActiveSheet.Columns(intLoop).ColumnWidth = varFldWidth(intLoop)
         Next
        .ActiveSheet.Range(.Cells(1, 1), .Cells(1, UBound(varFldName))).Select
        .Selection.Font.Name = "Arial"
        .Selection.Font.Size = 12
        ...
        '開始填入資料
        gcnGi.BeginTrans
         While Not rs.EOF  'Cells(Rows,1)=CPNumber Cells(Rows,2)=EBTIssue Cells(Rows,3)=KeepDate Cells(Rows,4)=useflag
             For intLoop = 1 To UBound(varFldName)
'                If rs(intLoop - 1).Name = "USEFLAG" Then
'                    If rs(intLoop - 1).value = 0 Then
'                        .ActiveSheet.Cells(rs.AbsolutePosition + 1, intLoop).value = "否"
'                    End If
'                Else
                    .ActiveSheet.Cells(rs.AbsolutePosition + 1, intLoop).Value = rs(intLoop - 1) & ""
'                End If
             Next
        '#3095 將門號取回日填入系統日期 by Kin 2007/3/21
            rs("RETDATE") = dtaWriteRcd
            rs.Update
            rs.MoveNext
            DoEvents
         Wend
    ...
    End With
    Set objXls = Nothing
    ExportKeepDateXls = True
  Exit Function
ChkErr:
    gcnGi.RollbackTrans
    ErrSub Me.Name, "ExportKeepDateXls"
End Function
Function GetChoose6() As String
    On Error GoTo ChkErr
        Dim strReturnSQL As String
        '日期
        If giKeepDate1.GetValue & "" <> "" Then Call subAnd2(strReturnSQL, " KeepDate>=To_Date('" & giKeepDate1.GetValue & "','YYYYMMDD')")
        If giKeepDate2.GetValue & "" <> "" Then Call subAnd2(strReturnSQL, " KeepDate<To_Date('" & giKeepDate2.GetValue & "','YYYYMMDD')+1")
        '必要條件
        strReturnSQL = IIf(strReturnSQL & "" = "", "", strReturnSQL & " And RetDate is Null And KeepDate is not null And UseFlag in (0,9)")
        GetChoose6 = strReturnSQL
    Exit Function
ChkErr:
 ErrSub Me.Name, "GetChoose6"
End Function
'寫入記錄檔
Sub WriteToLog6(ByVal strFile As String, ByVal intCount As Long, ByVal dtaRunTime As Date)
    On Error GoTo ChkErr
    Dim TxtFile As TextStream
    Dim strWriteContext As String
    If Fso.FileExists(strFile) Then Fso.DeleteFile strFile, True
    Set TxtFile = Fso.CreateTextFile(strFile)
    strWriteContext = "保管日期： " & Format(giKeepDate1.GetValue, "####/##/##") & "  ~  " & Format(giKeepDate2.GetValue, "####/##/##") & vbCrLf & _
                      "執行筆數： " & intCount & " 筆" & vbCrLf & _
                      "執行時間： " & Format(dtaRunTime, "yyyy/mm/dd hh:mm")
    TxtFile.WriteLine strWriteContext
    TxtFile.Close
    Exit Sub
ChkErr:
 ErrSub Me.Name, "WriteToLog6"
End Sub

'#3195將要存在SO19J0A.Ini的資訊先建立一個Collect集合
'Collect.Key=Section+Key+(元件+[元件的值]=KeyValue)
'Collect.Item=元件的預設值
Sub ReadIniPages()
  On Error Resume Next
    With iniPages
        ...
        .Add "PAGE0202," & txtLogFile3.Name, ""
        .Add "PAGE0203," & txtImportFile2.Name, ""
        .Add "PAGE0203," & txtLogFile2.Name, ""
        .Add "PAGE0301," & txtExportFile1.Name, gcnGi.Execute("Select SOCompCode From " & GetOwner & "CD039 Where CodeNo=" & gCompCode)(0).Value & "_PIH_U"
        .Add "PAGE0301," & txtExportPath1.Name, ""
        .Add "PAGE0301," & txtLogFile4.Name, ""
        .Add "PAGE0302," & txtExportFile2.Name, gcnGi.Execute("Select SOCompCode From " & GetOwner & "CD039 Where CodeNo=" & gCompCode)(0).Value & "_PIH_R"
        .Add "PAGE0302," & txtExportPath2.Name, ""
        .Add "PAGE0302," & txtLogFile5.Name, ""
        .Add "PAGE0303," & gimPrCode1.Name, ""
        .Add "PAGE0303," & gimReasonCode.Name, ""
        .Add "PAGE0303," & txtExportFile3.Name, gcnGi.Execute("Select SOCompCode From " & GetOwner & "CD039 Where CodeNo=" & gCompCode)(0).Value & "_REMOVE_R"
        .Add "PAGE0303," & txtExportPath3.Name, ""
        .Add "PAGE0304," & gimPrCode2.Name, ""
        .Add "PAGE0304," & gimUCCode.Name, ""
        .Add "PAGE0304," & txtExportFile4.Name, gcnGi.Execute("Select SOCompCode From " & GetOwner & "CD039 Where CodeNo=" & gCompCode)(0).Value & "_REMOVE_"
        .Add "PAGE0304," & txtExportPath4.Name, ""
        .Add "PAGE0305," & txtExportFile5.Name, gcnGi.Execute("Select SOCompCode From " & GetOwner & "CD039 Where CodeNo=" & gCompCode)(0).Value & "_REPAY_U"
        .Add "PAGE0305," & txtExportPath5.Name, ""
        .Add "PAGE0305," & txtLogFile6.Name, ""
        .Add "PAGE0306," & txtExportFile6.Name, ""
        .Add "PAGE0306," & txtExportPath6.Name, ""
        .Add "PAGE0306," & txtLogFile7.Name, ""
    End With
    If Right(strErrPath, 1) = "\" Then
        strIniFile = strErrPath & "SO19J0A.Ini"
    Else
        strIniFile = strErrPath & "\SO19J0A.Ini"
    End If
End Sub
