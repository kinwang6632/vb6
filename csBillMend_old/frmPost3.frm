  ...
  On Error GoTo ChkErr
    ...
    Else
        If strMedia = 1 Then
            ...
            If Not BatchUpdateMediaBillNo(rsUpd, strChoose33, gcnGi) Then Exit Function
        End If
        strSQL = "SELECT " & GetUseIndexStr("SO033", "ShouldDate") & " A.CitibankATM BillNo,Sum(A.ShouldAmt) ShouldAmt,A.AccountNo,TO_CHAR(A.ShouldDate,'YYYYMM') as ShouldDate,A.BillNo OldBillNo " & _
               "From " & strGetOwner & "SO033 A " & StrTableName & _
               " Where " & strWhere & _
...
'         '末筆
        ...
        WriteLineData "2" & GetString("", 1) & _
                   ...
                   IIf(intRefNo = 2, Space(5), "") & strLastData, 0
