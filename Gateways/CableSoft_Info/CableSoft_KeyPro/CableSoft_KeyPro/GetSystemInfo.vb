...
Public Class GetSystemInfo
    ...
    End Function
    '取出所有資訊
    Public Shared Function GetAllInfo(Optional ByVal blnEncry As Boolean = False) As String
        Dim aRet As String = String.Empty
    ...
    Public Overloads Shared Function DecryKeyPro(ByVal aStream As System.IO.Stream) As String
        ...
        End Try
    End Function
    Private Shared Function ProcRegister(ByVal aSourceStr As Array) As Boolean
        Try
            ...
            SyncLock intLckReg.GetType
                ...
                aSysInfo = GetAllInfo.Split(FSplitChar).GetValue(1).ToString.Split(Environment.NewLine)
        ...
        End Try
    End Function
    Public Overloads Shared Function IsRegister(ByVal aFile As String, Optional ByVal aShowForm As ShowForm = ShowForm.Yes) As Boolean
        Try
