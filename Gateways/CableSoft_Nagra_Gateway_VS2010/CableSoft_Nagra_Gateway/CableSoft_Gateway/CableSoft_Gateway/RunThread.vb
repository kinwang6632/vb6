...
Module RunThread
    ...
    Private Sub ThreadProcess(ByVal obj As List(Of SOInfoClass), ByVal timedOut As Boolean)
        ...
        Finally
            If aCanExit IsNot Nothing Then
                aCanExit.Dispose()
            End If
            For Each o As SOInfoClass In obj
                o.Dispose()
            Next
            'obj.Clear()
                ...
                If (FNagraHaveProcing < FNagraMaxProcing) Then
                    ...
                    If aSocketNum >= fSocket.Length Then
                        ...
                        If Not aThreadPoolOK Then
                            Try
                                SendCmdInfo.GetInfoLst(0).AllFieldsValue("CmdStatus".ToUpper) = "W"
                                SendCmdInfo.GetInfoLst(0).AllFieldsValue("ErrCode".ToUpper) = "-9997"
                                SendCmdInfo.GetInfoLst(0).AllFieldsValue("ErrMsg".ToUpper) = "CableSoft_Socket_All_Disconnect"
                    ...
                    Using r As OracleDataReader = cmd.ExecuteReader(CommandBehavior.CloseConnection)
                        ...
                        While r.Read
                            Try
                                ...
                                SendCmdInfo.ADD(obj.CompID, obj.CompName, r("SeqNo"), r("CMD"), obj.OraConnectString, r)
                            Catch ex As Exception
                                SyncLock obj.WaitProcessNumber.GetType
    ...
    Private Sub SendNagraCmd(ByVal aInfo As List(Of Object))
        ...
        Try
            ...
            If fSocket(aSocketNum.Value) Is Nothing Then
                aSoCmdInfo.Value.AllFieldsValue("CmdStatus".ToUpper) = "W"
            ...
            SyncLock fSocket(aSocketNum.Value)
                Try
                    ...
                    If (aryMsg.Value Is Nothing) OrElse (aryMsg.Value.Count = 0) Then
                        aSoCmdInfo.Value.AllFieldsValue("CmdStatus".ToUpper) = "E"
                        aSoCmdInfo.Value.AllFieldsValue("ErrCode".ToUpper) = Int32.Parse(CustomerNagraError.CableSoft_0851String_Error).ToString
                        aSoCmdInfo.Value.AllFieldsValue("ErrMsg".ToUpper) = [Enum].GetName(GetType(CustomerNagraError), CustomerNagraError.CableSoft_0851String_Error)
                        aSoCmdInfo.Value.Returnlicenses.Clear()
                        aSoCmdInfo.Value.NagraSendAndRecvMsg.Clear()
                        UpdateSysErrUI(New Exception("0851產生資料失敗"), " [" & aSoCmdInfo.Value.CompName & "] 命令序號 [ " & aSoCmdInfo.Value.SEQNO & " ]")
    ...
    Public Sub UpdUiAndDB(ByVal aSOCmdInfo As SOCMDInfo)
        Try
            ...
            UpdSO560(aSOCmdInfo)
            If (aSOCmdInfo.AllFieldsValue("CmdStatus".ToUpper).ToUpper = "E".ToUpper) AndAlso _
                    (fErrSndMail) AndAlso (fIsUseMail) Then
                csCommon.SendMail(MDBMailPara.GetDefaultMDBName, _
                                  fMDBMailPassword, "CMD_ERR", fMailInfoTableName, _
                            fMailToTableName, fMailCCTableName, "PRM_GATEWAY 命令有錯", _
        ...
        Try
            For i As Int32 = 1 To FRcvErrStopCnt
                Try
                    ...
                    Do
                        If (aTimeStop.Value.Elapsed.Seconds) >= (FRcvTimeout) Then
                            aCmdInfo.AllFieldsValue.Item("CmdStatus".ToUpper) = "T"
                            aCmdInfo.AllFieldsValue.Item("ErrCode".ToUpper) = String.Empty
                            aCmdInfo.AllFieldsValue.Item("ErrMsg".ToUpper) = String.Empty
                        ...
                        If (fSocket(aSocketNum) Is Nothing) OrElse (Not fSocket(aSocketNum).Connected) Then
                            aCmdInfo.AllFieldsValue.Item("CmdStatus".ToUpper) = "E"
                            aCmdInfo.AllFieldsValue.Item("ErrCode".ToUpper) = CustomerNagraError.CableSoft_Recv_Socket_Disconnect
                            aCmdInfo.AllFieldsValue.Item("ErrMsg".ToUpper) = [Enum].GetName(GetType(CustomerNagraError), CustomerNagraError.CableSoft_Recv_Socket_Disconnect)
                            aTimeStop.Dispose()
                            pos.Dispose()
                            Return False
                        End If
                            ...
                            If pos.Value > 0 Then
                                ...
                                If pos.Value <= aRetCmdString.Value.Length Then
                                    ...
                                    Select Case aNagraStatus.Status
                                        Case AckCode.Ack
                                            aCmdInfo.AllFieldsValue.Item("CmdStatus".ToUpper) = "S1"
                                            aCmdInfo.AllFieldsValue.Item("ErrCode".ToUpper) = String.Empty
                                            aCmdInfo.AllFieldsValue.Item("ErrMsg".ToUpper) = String.Empty
                                            pos.Dispose()
                                            aRcvBty.Dispose()
                                        ...
                                        Case AckCode.Nack
                                            aCmdInfo.AllFieldsValue.Item("CmdStatus".ToUpper) = "E"
                                            aCmdInfo.AllFieldsValue.Item("ErrCode".ToUpper) = aNagraStatus.ErrorCode
                                            aCmdInfo.AllFieldsValue.Item("ErrMsg".ToUpper) = aNagraStatus.ErrorName
                                        ...
                                        Case AckCode.Other
                                            aCmdInfo.AllFieldsValue.Item("CmdStatus".ToUpper) = "E"
                                            aCmdInfo.AllFieldsValue.Item("ErrCode".ToUpper) = aNagraStatus.ErrorCode
                                            aCmdInfo.AllFieldsValue.Item("ErrMsg".ToUpper) = "CableSoft_Recv_Othre_Error"
                                    End Select
                                    aRcvBty.Dispose()
                                    pos.Dispose()
                                    aTimeStop.Dispose()
                ...
                Catch ex As SocketException
                    ...
                    aCmdInfo.AllFieldsValue.Item("CmdStatus".ToUpper) = "E"
                    aCmdInfo.AllFieldsValue.Item("ErrCode".ToUpper) = Int32.Parse(ex.SocketErrorCode)
                    aCmdInfo.AllFieldsValue.Item("ErrMsg".ToUpper) = ex.SocketErrorCode
                    Return False
                ...
                Catch ex As Exception
                    ...
                    If i = FRcvErrStopCnt Then
                        aCmdInfo.AllFieldsValue.Item("CmdStatus".ToUpper) = "E"
                        aCmdInfo.AllFieldsValue.Item("ErrCode".ToUpper) = CustomerNagraError.CableSoft_Socket_Recv_Error
                        aCmdInfo.AllFieldsValue.Item("ErrMsg".ToUpper) = [Enum].GetName(GetType(CustomerNagraError), CustomerNagraError.CableSoft_Socket_Recv_Error)
                        Return False
                    End If
                End Try
            Next
        ...
        Try
            For i As Int32 = 1 To FSndErrStopCnt
                Try
                    If (fSocket(aSocketNum) Is Nothing) OrElse (Not fSocket(aSocketNum).Connected) Then
                        aCMDInfo.AllFieldsValue.Item("CmdStatus".ToUpper) = "E"
                        aCMDInfo.AllFieldsValue.Item("ErrCode".ToUpper) = Int32.Parse(CustomerNagraError.CableSoft_Socket_Disconnect).ToString
                        aCMDInfo.AllFieldsValue.Item("ErrMsg".ToUpper) = [Enum].GetName(GetType(CustomerNagraError), CustomerNagraError.CableSoft_Socket_Disconnect)
                        Return False
                    End If
                ...
                Catch ex As SocketException
                    ...
                    aCMDInfo.AllFieldsValue.Item("CmdStatus".ToUpper) = "E"
                    aCMDInfo.AllFieldsValue.Item("ErrCode".ToUpper) = ex.SocketErrorCode.ToString
                    aCMDInfo.AllFieldsValue.Item("ErrMsg".ToUpper) = [Enum].GetName(GetType(SocketError), ex.SocketErrorCode)
                ...
                Catch ex As Exception
                    ...
                    If i = FSndErrStopCnt Then
                        ...
                        aCMDInfo.AllFieldsValue.Item("CmdStatus".ToUpper) = "E"
                        aCMDInfo.AllFieldsValue.Item("ErrCode".ToUpper) = CustomerNagraError.CableSoft_Socket_SndOver
                        aCMDInfo.AllFieldsValue.Item("ErrMsg".ToUpper) = [Enum].GetName(GetType(CustomerNagraError), CustomerNagraError.CableSoft_Socket_SndOver)
                        Return False
                    End If
                End Try
    ...
    Public Shared Function ADD(ByVal aCompID As String, ByVal aCompName As String, _
        ...
        Try
            ...
            SyncLock aDataReader
                ...
                End If
                objList.Item("CmdStatus".ToUpper) = "P1"
