      ...
      Screen.MousePointer = vbHourglass
        ...
        Me.Enabled = False
          ...
          Else
            ...
            If blnExcel Then
                RptToTxt "SO5270AE.rpt", , strsql, strChooseString, , "Tmp0000.MDB", strGroupName, , , Environ("Temp") & "\SO5270"
                If Not Get_RS_From_Txt(Environ("Temp"), "SO5270.txt", rsExcel) Then blnExcel = False: Exit Sub
