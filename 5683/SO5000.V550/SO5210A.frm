...
'        If gymClctYM2.GetValue <> "" Then Call subAnd("SO033.ClctYM < To_Date('" & gymClctYM2.GetValue & "','YYYYMM')+1")
        ...
        End If
        '#5267 原本是串SO002A,現在改串SO106 By Kin 2010/04/23
...
'                   " From " & strViewName & strSort, gcnGi, adUseServer
        ...
        Else
            ...
            Else
                ...
                '#5267 原本是串SO002A,現在改串SO106 By Kin 2010/04/26
                ...
                If strChooseSO002A <> "" Then strChooseSO002 = ",SO106" & IIf(strChooseSO002 = "", " WHERE ", strChooseSO002 & " AND ") & "SO033.CUSTID=SO106.CUSTID AND SO033.AccountNo=SO106.AccountID AND " & strChooseSO002A
              ...
              '信用卡卡別
                '原本是串SO002A,現在改串SO106 By Kin 2010/04/26
                ...
                If strChooseSO002A = "" Then strChooseSO002 = ",SO106" & IIf(strChooseSO002 = "", " WHERE ", strChooseSO002 & " AND ") & "SO033.CUSTID=SO106.CUSTID(+) AND SO033.AccountNo=SO106.AccountID(+) "
...
'                                   ") SO033" & strTableSO004 & strChooseSO002 & strWhereSO004 & " Group by SO002A.CardName"
                    ...
                    strSubQry(5) = "SELECT Distinct SO106.CardName,Count(Distinct SO033.Custid) CountCustid,Count(Distinct SO106.CardName) CountCardName " & strSumCust & _
                         " From(" & _
                             "Select SO033.Custid,SO033.AccountNo,SO033.ServiceType From SO033" & strTableSO007 & " Where " & strChoose & _
                       ") SO033" & strTableSO004 & strChooseSO002 & strWhereSO004 & " Group by SO106.CardName"
                       
                    strSubQry2(5) = "SELECT Distinct SO106.CardName,Count(Distinct SO033.Custid) CountCustid,Count(Distinct SO106.CardName) CountCardName " & strSumCust & _
                                         " From(" & _
                                             "Select SO033.Custid,SO033.AccountNo,SO033.ServiceType From SO033" & strTableSO007 & " Where " & strChoose & _
                                             " Union all Select SO035.Custid,SO035.AccountNo,SO035.ServiceType From SO035" & strTableSO007 & " Where " & strChoose35 & _
                                       ") SO033" & strTableSO004 & strChooseSO002 & strWhereSO004 & " Group by SO106.CardName"
...
Private Function subCreateTable() As Boolean
  ...
  Dim strSO138Table As String
    ...
    strCardExpDate = "Max(DeCode(length(SO106.StopYM),5,substr(SO106.StopYM,2,4) || '0' || substr(SO106.StopYM,1,1),substr(SO106.StopYM,3,4) ||  substr(SO106.StopYM,1,2))) As CardExpDate "
    ...
    End If
    '#5267 原本串SO002A,現在改串SO106 By Kin 2010/04/23
    If strChooseSO002A <> "" Then
        strTable = strTable & ",SO106"
        strWhere = strWhere & " And SO106.AccountID=SO033.AccountNo And SO106.Custid=SO033.Custid And SO106.CompCode=SO033.CompCode AND " & strChooseSO002A
    End If
    ...
    If optDail.Value Then
        ...
        Select Case cboAddress.ListIndex
            ...
            Case Else
                strTable = strTable & ",SO014"
                strWhere = strWhere & " And So033.AddrNo=SO014.AddrNo And SO033.CompCode=SO014.CompCode "
                strSO138Table = strWhere & " And SO033.CompCode=SO014.CompCode "
        End Select
        For intFor = 1 To 10
        ...
        '#5627 地址資訊要串SO138.INVSEQNO By Kin 2010/05/24
        '#5683 增加SO033.PayKind By Kin 2010/08/13
        strField = "SO033.CUSTID,SO033.BILLNO,SO033.RealStartDate,SO033.RealStopDate," & _
                    "SO033.SHOULDDATE,SO033.CitemCode,SO033.CitemName,SO033.ShouldAmt,SO033.UCNAME," & _
                    "SO033.CLCTNAME,SO033.AreaCode,SO033.ClctEn,SO033.ServCode,SO033.GUINo," & _
                    "SO033.PrtSNo,SO033.ClctAreaCode,SO033.ServiceType,SO033.AddrNo,SO033.ClassCode," & _
                    "SO033.AccountNo,SO033.CompCode,SO033.MediaBillNo,SO033.RealPeriod," & _
                    "SO033.UpdTime,SO033.OldClctName,SO004.DeclarantName,SO033.INVSEQNO," & _
        ...
        If GetUserPriv("SO1100G", "(SO1100G9)") Then
            strPrivAccount = "SO033.AccountNo "
        Else
            strPrivAccount = "Decode(SO033.AccountNo,Null,SO033.AccountNo,SubStr(SO033.AccountNo,1,5) || 'XXX' || " & _
                           "SubStr(SO033.AccountNo,9,2) || 'XX' || SubStr(SO033.AccountNo,Length(SO033.AccountNo)-3,4)) "
        End If
        '******************************************************************************************************************************
        '#2810 匯出Excel要增加帳號、信用卡到期日、申請人姓名、申請人電話 By Kin 2007/05/10
        strCustName = "Decode(SO033.DeclarantName,Null,SO001.CustName,SO033.DeclarantName)  "
        strTel1 = "Decode(SO033.DeclarantName,Null,SO001.TEL1,SO033.ContTel)  "
        '**************************************************************************************************************************************************************************************
        ...
        '#5267 原本串SO002A,現在改串SO106 By Kin 2010/04/23
'        strView = "SELECT SO033.CUSTID,SO033.BILLNO,SO033.RealStartDate,SO033.RealStopDate,SO033.SHOULDDATE,SO033.CitemCode,SO033.CitemName,SO033.ShouldAmt,SO033.UCNAME," & _
'                  "SO033.CLCTNAME," & strCustName & "," & strTel1 & ",SO001.TEL2,SO001.TEL3,CD004.Description,SO014.ADDRESS,SO014.SERVNAME,SO014.AreaCode,SO014.AreaName,SO033.ClctEn," & _
'                  "SO014.ServCode,SO033.GUINo,SO014.AddrSort,SO033.PrtSNo,SO033.ClctAreaCode,SO014.ClctAreaName,SO002.CustStatusName,SO014.MDUName,SO002A.CardName,SO033.MediaBillNo," & _
'                  "SO033.RealPeriod,SO033.UpdTime,SO033.OldClctName," & strPrivAccount & "," & strCardExpDate & ",SO033.DeclarantName,SO033.ContTel,SO033.NOTE,SO014.CircuitNo,SO033.BpCode,SO033.BpName " & strFieldFaci & _
'                      "From (" & strView & _
...
'                  IIf(strChooseSO002 = "", "", " And " & strChooseSO002) & IIf(strChooseSO002A = "", "", " And " & strChooseSO002A) & strWhereSO004
        If cboAddress.ListIndex = 2 Then
            'strSO138Where = " AND SO033.INVSEQNO IS NULL "
            '#5683 增加SO033.PayKind By Kin 2010/08/13
            strSO138Table = "SELECT SO033.CUSTID,SO033.BILLNO,SO033.RealStartDate,SO033.RealStopDate,SO033.SHOULDDATE,SO033.CitemCode,SO033.CitemName,SO033.ShouldAmt,SO033.UCNAME," & _
                  "SO033.CLCTNAME," & strCustName & " CustName," & strTel1 & " TEL1,SO001.TEL2,SO001.TEL3,CD004.Description,SO014.ADDRESS,SO014.SERVNAME,SO014.AreaCode,SO014.AreaName,SO033.ClctEn," & _
                  "SO014.ServCode,SO033.GUINo,SO014.AddrSort,SO033.PrtSNo,SO033.ClctAreaCode,SO014.ClctAreaName,SO002.CustStatusName,SO014.MDUName,SO106.CardName,SO033.MediaBillNo," & _
                  "SO033.RealPeriod,SO033.UpdTime,SO033.OldClctName," & _
                  strPrivAccount & " AccountNo," & strCardExpDate & _
                  ",SO033.DeclarantName,SO033.ContTel,SO033.NOTE,SO014.CircuitNo," & _
                  " SO033.BpCode,SO033.BpName,SO033.PayKind " & strFieldFaci & _
                      "From (" & strView & _
                      ") SO033,SO001,SO014,CD004,SO002,SO106,SO138 " & strTableSO004 & _
                  " Where SO002.Custid=SO033.Custid And SO002.ServiceType=SO033.ServiceType And SO002.CompCode=SO033.CompCode And SO001.CUSTID=SO033.CUSTID" & _
                  " And SO001.CompCode=SO033.CompCode " & strSO138Where & _
                  " And SO033.ClassCode=CD004.CodeNo(+) And SO033.AccountNo=SO106.AccountID(+) And SO106.Custid(+)=SO033.Custid And SO106.CompCode(+)=SO033.CompCode" & _
                  " AND SO033.INVSEQNO IS NOT NULL AND SO033.INVSEQNO=SO138.INVSEQNO " & _
                  " AND SO138.ChargeAddrNo=SO014.AddrNo " & _
                  IIf(strChooseSO002 = "", "", " And " & strChooseSO002) & IIf(strChooseSO002A = "", "", " And " & strChooseSO002A) & strWhereSO004 & _
                  " Group By  SO033.CUSTID,SO033.BILLNO,SO033.RealStartDate,SO033.RealStopDate,SO033.SHOULDDATE,SO033.CitemCode,SO033.CitemName,SO033.ShouldAmt,SO033.UCNAME," & _
                  "SO033.CLCTNAME," & strCustName & "," & strTel1 & ",SO001.TEL2,SO001.TEL3,CD004.Description,SO014.ADDRESS,SO014.SERVNAME,SO014.AreaCode,SO014.AreaName,SO033.ClctEn," & _
                  "SO014.ServCode,SO033.GUINo,SO014.AddrSort,SO033.PrtSNo,SO033.ClctAreaCode,SO014.ClctAreaName,SO002.CustStatusName,SO014.MDUName,SO106.CardName,SO033.MediaBillNo," & _
                  "SO033.RealPeriod,SO033.UpdTime,SO033.OldClctName," & strPrivAccount & ",SO033.DeclarantName,SO033.ContTel,SO033.NOTE,SO014.CircuitNo,SO033.BpCode,SO033.BpName,SO033.PayKind "
            strSO138Table = " UNION ALL " & strSO138Table
        ...
        strView = "SELECT SO033.CUSTID,SO033.BILLNO,SO033.RealStartDate,SO033.RealStopDate,SO033.SHOULDDATE,SO033.CitemCode,SO033.CitemName,SO033.ShouldAmt,SO033.UCNAME," & _
                  ...
                  "SO033.BpCode,SO033.BpName,SO033.PayKind " & strFieldFaci & _
                      "From (" & strView & _
                      ") SO033,SO001,SO014,CD004,SO002,SO106 " & strTableSO004 & _
                  " Where SO002.Custid=SO033.Custid And SO002.ServiceType=SO033.ServiceType And SO002.CompCode=SO033.CompCode And SO001.CUSTID=SO033.CUSTID" & _
                  " And SO001.CompCode=SO033.CompCode " & strWhere & _
                  " And SO033.ClassCode=CD004.CodeNo(+) And SO033.AccountNo=SO106.AccountID(+) And SO106.Custid(+)=SO033.Custid And SO106.CompCode(+)=SO033.CompCode" & _
                  IIf(cboAddress.ListIndex = 2, " AND SO033.INVSEQNO IS NULL ", "") & _
                  IIf(strChooseSO002 = "", "", " And " & strChooseSO002) & IIf(strChooseSO002A = "", "", " And " & strChooseSO002A) & strWhereSO004 & _
                  " Group By  SO033.CUSTID,SO033.BILLNO,SO033.RealStartDate,SO033.RealStopDate,SO033.SHOULDDATE,SO033.CitemCode,SO033.CitemName,SO033.ShouldAmt,SO033.UCNAME," & _
                  "SO033.CLCTNAME," & strCustName & "," & strTel1 & ",SO001.TEL2,SO001.TEL3,CD004.Description,SO014.ADDRESS,SO014.SERVNAME,SO014.AreaCode,SO014.AreaName,SO033.ClctEn," & _
                  "SO014.ServCode,SO033.GUINo,SO014.AddrSort,SO033.PrtSNo,SO033.ClctAreaCode,SO014.ClctAreaName,SO002.CustStatusName,SO014.MDUName,SO106.CardName,SO033.MediaBillNo," & _
                  "SO033.RealPeriod,SO033.UpdTime,SO033.OldClctName," & strPrivAccount & ",SO033.DeclarantName,SO033.ContTel,SO033.NOTE,SO014.CircuitNo,SO033.BpCode,SO033.BpName,SO033.PayKind "
        strView = strView & strSO138Table
        '****************************************************************************************************************************************************************************************
       
        strGroup = " Group By  SO033.CUSTID,SO033.BILLNO,SO033.RealStartDate,SO033.RealStopDate,SO033.SHOULDDATE,SO033.CitemCode,SO033.CitemName,SO033.ShouldAmt,SO033.UCNAME," & _
                  "SO033.CLCTNAME," & strCustName & "," & strTel1 & ",SO001.TEL2,SO001.TEL3,CD004.Description,SO014.ADDRESS,SO014.SERVNAME,SO014.AreaCode,SO014.AreaName,SO033.ClctEn," & _
                  "SO014.ServCode,SO033.GUINo,SO014.AddrSort,SO033.PrtSNo,SO033.ClctAreaCode,SO014.ClctAreaName,SO002.CustStatusName,SO014.MDUName,SO106.CardName,SO033.MediaBillNo," & _
                  "SO033.RealPeriod,SO033.UpdTime,SO033.OldClctName," & strPrivAccount & ",SO033.DeclarantName,SO033.ContTel,SO033.NOTE,SO014.CircuitNo,SO033.BpCode,SO033.BpName,SO033.PayKind "
