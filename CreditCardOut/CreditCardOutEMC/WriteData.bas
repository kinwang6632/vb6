...
Public blnChkPayKindOK As Boolean
Public Enum giArrow
    giLeft = 0
    GIRIGHT = 1
End Enum
...
Public Enum ChkPayKind
    ...
    giAll = 1
End Enum
Public strSpcNo As String
Public strSpcNo2 As String

Public strFuBonCmCode As String
Public strFuBonCmName As String
Public blnFubonIntegrate As Boolean
Public Function GetChkPayKind() As Boolean
    On Error Resume Next
    Dim aRet As Boolean
    aRet = False
    aRet = Val(objStorePara.Connection.Execute("SELECT NVL(PayNowChkStopDate,0) FROM " & TableOwnerName & "SO041")(0)) = 1
    GetChkPayKind = aRet
