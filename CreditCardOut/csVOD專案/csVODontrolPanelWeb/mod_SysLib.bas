...
Public Const FormName = "csVODcontrol"
...
Public Function GetPremission(strMID As String) As Boolean
    ...
    Dim rs As New ADODB.Recordset
        ...
        If gstrUserPremission = "" Then
            If Not GetRS(rs, "Select Mid From " & GetOwner & "So029 Where Link like 'SO1124%' And Group" & GaryGi(4) & " = 1") Then Exit Function
...
Public Function Get_Cmd_Seq_No(ByRef cnObj As Object) As String
  On Error GoTo ChkErr
    Get_Cmd_Seq_No = RPxx(cnObj.Execute("SELECT " & strOwner & "s_so555_seqno.NEXTVAL FROM DUAL").GetString & "")
