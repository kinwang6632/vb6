...
Public Class Form1
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim strContent As String = "server=(local);uid=myid;pwd=mypwd;database=mydata"
        Dim strResult As String = CryptUtil.Encrypt(strContent)
        MessageBox.Show(strResult)
        MessageBox.Show(CryptUtil.Decrypt(strResult))
