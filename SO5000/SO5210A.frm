...
Private Sub subChoose()
  On Error GoTo ChkErr
    ...
    Dim strCustid As String
        ...
        blnPrtSNo = False
        strTableSO007 = ""
        '繳付類別要抓CD112的Description
        Call subAnd("Nvl(SO033.PayKind,0)=CD112.CodeNo")
        '日期
        ...
        If gdaShouldDate2.GetValue <> "" Then Call subAnd("SO033.ShouldDate < To_Date('" & gdaShouldDate2.GetValue & "','YYYYMMDD')+1")
        'If gdtUpdTime1.GetValue <> "" Then subAnd ("GiPackage.GetDate1(UpdTime) >= " & GetNullString(gdtUpdTime1.GetValue(True), giDateV, giOracle, True) & "")
        '改用GiPackage.GetDate Function By Kin 2011/10/18
        If gdtUpdTime1.GetValue <> "" Then subAnd ("GiPackage.GetDate1(SO033.UpdTime) >= " & GetNullString(gdtUpdTime1.GetValue(True), giDateV, giOracle, True) & "")
        If gdtUpdTime2.GetValue <> "" Then subAnd ("GiPackage.GetDate1(SO033.UpdTime) <= " & GetNullString(gdtUpdTime2.GetValue(True), giDateV, giOracle, True) & "")
...
'        If gymClctYM2.GetValue <> "" Then Call subAnd("SO033.ClctYM < To_Date('" & gymClctYM2.GetValue & "','YYYYMM')+1")
        ...
        End If
        '#7553 By Kin 2017/07/07
        If gimSuite.GetQryStr <> "" Then
            Call subAnd2(strChooseSO001, "SO001.AMduId  " & gimSuite.GetQryStr)
        Else
            If gimSuite.GetDispStr <> "" Then Call subAnd2(strChooseSO001, "SO001.AMduId  is Not null ")
        End If
            ...
            Else
              ...
              '#4289 選擇裝機類別要多串SO007 By Kin 2008/12/17
                strSubQry(0) = "SELECT SO033.CitemName,Sum(SO033.ShouldAmt) SumShouldAmt,Count(*) Counts,Count(Distinct SO033.Custid) CountCustid,Count(Distinct SO033.BillNo) CountBillNo " & strSumCust & _
                                     " From(" & _
                                       "Select SO033.CitemName,SO033.ShouldAmt,SO033.Custid,SO033.BillNo,SO033.ServiceType,SO033.AccountNo From SO033,CD112" & strTableSO007 & " Where " & strChoose & _
                ...
                strSubQry2(0) = "SELECT SO033.CitemName,Sum(SO033.ShouldAmt) SumShouldAmt,Count(*) Counts,Count(Distinct SO033.Custid) CountCustid,Count(Distinct SO033.BillNo) CountBillNo " & strSumCust & _
                                     " From(" & _
                                       "Select SO033.CitemName,SO033.ShouldAmt,SO033.Custid,SO033.BillNo,SO033.ServiceType,SO033.AccountNo From SO033,CD112" & strTableSO007 & " Where " & strChoose & _
                                       " Union all Select SO035.CitemName,SO035.ShouldAmt,SO035.Custid,SO035.BillNo,SO035.ServiceType,SO035.AccountNo From SO035,CD112" & strTableSO007 & " Where " & strChoose35 & _
                                  ") SO033" & strTableSO004 & strChooseSO002 & strWhereSO004 & " Group by SO033.CitemName"
               '#4289 選擇裝機類別要多串SO007 By Kin 2008/12/17
              ...
              '服務區
                strSubQry(1) = "SELECT SO014.ServName,Sum(SO033.ShouldAmt) SumShouldAmt,Count(*) Counts,Count(Distinct SO033.Custid) CountCustid,Count(Distinct SO033.BillNo) CountBillNo " & strSumCust & _
                                     " From(" & _
                                         "Select SO033.ShouldAmt,SO033.Custid,SO033.BillNo,SO033.ServiceType,SO033.AddrNo,SO033.AccountNo From SO033,CD112" & strTableSO007 & " Where " & strChoose & _
                ...
                strSubQry2(1) = "SELECT SO014.ServName,Sum(SO033.ShouldAmt) SumShouldAmt,Count(*) Counts,Count(Distinct SO033.Custid) CountCustid,Count(Distinct SO033.BillNo) CountBillNo " & strSumCust & _
                                     " From(" & _
                                         "Select SO033.ShouldAmt,SO033.Custid,SO033.BillNo,SO033.ServiceType,SO033.AddrNo,SO033.AccountNo From SO033,CD112" & strTableSO007 & " Where " & strChoose & _
                                         " Union all Select SO035.ShouldAmt,SO035.Custid,SO035.BillNo,SO035.ServiceType,SO035.AddrNo,SO035.AccountNo From SO035,CD112" & strTableSO007 & " Where " & strChoose35 & _
                                   ") SO033,SO014" & strTableSO004 & IIf(strChooseSO002 = "", " Where ", strChooseSO002 & " And ") & "SO033.ADDRNO=SO014.ADDRNO " & strWhereSO004 & " Group by SO014.ServName"
              ...
              '收費人員+收費項目
                ...
                If Para24 = 1 Then
                    strSubQry(2) = "SELECT SO033.CLCTNAME,SO033.CitemName,SO033.ShouldAmt,Count(*) Counts,Sum(SO033.ShouldAmt) SumShouldAmt,Count(Distinct SO033.MEDIABILLNO) CountBillNo " & _
                                   " From(" & _
                                        "Select SO033.CLCTNAME,SO033.CitemName,SO033.ShouldAmt," & _
                                        "SO033.Custid,SO033.MEDIABILLNO,SO033.ServiceType," & _
                                        "SO033.AccountNo From SO033,CD112" & strTableSO007 & " Where " & _
                                        strChoose & _
                    ...
                    strSubQry2(2) = "SELECT SO033.CLCTNAME,SO033.CitemName,SO033.ShouldAmt,Count(*) Counts,Sum(SO033.ShouldAmt) SumShouldAmt,Count(Distinct SO033.MEDIABILLNO) CountBillNo " & _
                                   " From(" & _
                                        "Select SO033.CLCTNAME,SO033.CitemName,SO033.ShouldAmt," & _
                                        "SO033.Custid,SO033.MEDIABILLNO,SO033.ServiceType," & _
                                        "SO033.AccountNo From SO033,CD112" & strTableSO007 & " Where " & strChoose & _
                                        " Union all Select SO035.CLCTNAME,SO035.CitemName," & _
                                        "SO035.ShouldAmt,SO035.Custid,SO035.MEDIABILLNO," & _
                                        "SO035.ServiceType,SO035.AccountNo From SO035,CD112" & strTableSO007 & " Where " & strChoose35 & _
                                   ") SO033" & strTableSO004 & strChooseSO002 & strWhereSO004 & " Group by SO033.CLCTNAME,SO033.CitemName,SO033.ShouldAmt"
                ...
                Else
                    strSubQry(2) = "SELECT SO033.CLCTNAME,SO033.CitemName,SO033.ShouldAmt,Count(*) Counts,Sum(SO033.ShouldAmt) SumShouldAmt,Count(Distinct SO033.BillNo) CountBillNo " & _
                                         " From(" & _
                                             "Select SO033.CLCTNAME,SO033.CitemName,SO033.ShouldAmt," & _
                                             "SO033.Custid,SO033.BillNo,SO033.ServiceType," & _
                                             "SO033.AccountNo From SO033,CD112" & strTableSO007 & " Where " & strChoose & _
                                     ") SO033" & strTableSO004 & strChooseSO002 & strWhereSO004 & " Group by SO033.CLCTNAME,SO033.CitemName,SO033.ShouldAmt"
                    ...
                    strSubQry2(2) = "SELECT SO033.CLCTNAME,SO033.CitemName,SO033.ShouldAmt,Count(*) Counts,Sum(SO033.ShouldAmt) SumShouldAmt,Count(Distinct SO033.BillNo) CountBillNo " & _
                                         " From(" & _
                                             ...
                                             " Union all Select SO035.CLCTNAME,SO035.CitemName," & _
                                             "SO035.ShouldAmt,SO035.Custid,SO035.BillNo," & _
                                             "SO035.ServiceType,SO035.AccountNo From SO035,CD112" & strTableSO007 & " Where " & strChoose35 & _
                                     ") SO033" & strTableSO004 & strChooseSO002 & strWhereSO004 & " Group by SO033.CLCTNAME,SO033.CitemName,SO033.ShouldAmt"
                End If
              ...
              '行政區
                strSubQry(3) = "SELECT SO014.AreaName,Sum(SO033.ShouldAmt) SumShouldAmt,Count(*) Counts,Count(Distinct SO033.Custid) CountCustid,Count(Distinct SO033.BillNo) CountBillNo " & strSumCust & _
                                     " From(" & _
                                         "Select SO033.ShouldAmt,SO033.Custid,SO033.BillNo," & _
                                         "SO033.ServiceType,SO033.AddrNo,SO033.AccountNo From SO033,CD112" & strTableSO007 & " Where " & strChoose & _
                ...
                strSubQry2(3) = "SELECT SO014.AreaName,Sum(SO033.ShouldAmt) SumShouldAmt,Count(*) Counts,Count(Distinct SO033.Custid) CountCustid,Count(Distinct SO033.BillNo) CountBillNo " & strSumCust & _
                                     " From(" & _
                                         "Select SO033.ShouldAmt,SO033.Custid,SO033.BillNo," & _
                                         "SO033.ServiceType,SO033.AddrNo,SO033.AccountNo From SO033,CD112" & strTableSO007 & " Where " & strChoose & _
                                         " Union all Select SO035.ShouldAmt,SO035.Custid," & _
                                         "SO035.BillNo,SO035.ServiceType,SO035.AddrNo,SO035.AccountNo From SO035,CD112" & strTableSO007 & " Where " & strChoose35 & _
                                   ") SO033,SO014" & strTableSO004 & IIf(strChooseSO002 = "", " Where ", strChooseSO002 & " And ") & "SO033.ADDRNO=SO014.ADDRNO " & strWhereSO004 & " Group by SO014.AreaName"
              ...
              '未收原因
                strSubQry(4) = "SELECT SO033.UCName,Sum(SO033.ShouldAmt) SumShouldAmt,Count(*) Counts,Count(Distinct SO033.Custid) CountCustid,Count(Distinct SO033.BillNo) CountBillNo " & strSumCust & _
                                     " From(" & _
                                         "Select SO033.UCName,SO033.ShouldAmt,SO033.Custid," & _
                                         "SO033.BillNo,SO033.ServiceType,SO033.AccountNo From SO033,CD112" & strTableSO007 & " Where " & strChoose & _
                ...
                strSubQry2(4) = "SELECT SO033.UCName,Sum(SO033.ShouldAmt) SumShouldAmt,Count(*) Counts,Count(Distinct SO033.Custid) CountCustid,Count(Distinct SO033.BillNo) CountBillNo " & strSumCust & _
                                     " From(" & _
                                         "Select SO033.UCName,SO033.ShouldAmt,SO033.Custid,SO033.BillNo," & _
                                         "SO033.ServiceType,SO033.AccountNo From SO033,CD112" & strTableSO007 & " Where " & strChoose & _
                                         " Union all Select SO035.UCName,SO035.ShouldAmt,SO035.Custid," & _
                                         "SO035.BillNo,SO035.ServiceType,SO035.AccountNo From SO035,CD112" & strTableSO007 & " Where " & strChoose35 & _
                                   ") SO033" & strTableSO004 & strChooseSO002 & strWhereSO004 & " Group by SO033.UCName"
              ...
              '信用卡卡別
                ...
                strSubQry(5) = "SELECT SO002A.CardName,Count(Distinct SO033.Custid) CountCustid,Count(Distinct SO002A.CardName) CountCardName " & strSumCust & _
                                     " From(" & _
                                         "Select SO033.Custid,SO033.AccountNo," & _
                                         "SO033.ServiceType From SO033,CD112" & strTableSO007 & " Where " & strChoose & _
                ...
                strSubQry2(5) = "SELECT SO002A.CardName,Count(Distinct SO033.Custid) CountCustid,Count(Distinct SO002A.CardName) CountCardName " & strSumCust & _
                                     " From(" & _
                                         "Select SO033.Custid,SO033.AccountNo," & _
                                         "SO033.ServiceType From SO033,CD112" & strTableSO007 & " Where " & strChoose & _
                                         " Union all Select SO035.Custid,SO035.AccountNo," & _
                                         "SO035.ServiceType From SO035,CD112" & strTableSO007 & " Where " & strChoose35 & _
                                   ") SO033" & strTableSO004 & strChooseSO002 & strWhereSO004 & " Group by SO002A.CardName"
                ...
                strSubQry(6) = "SELECT CD004.Description,Sum(SO033.ShouldAmt) SumShouldAmt,Count(*) Counts,Count(Distinct SO033.Custid) CountCustid,Count(Distinct SO033.BillNo) CountBillNo " & _
                                     " From(" & _
                                         "Select SO033.ShouldAmt,SO033.Custid,SO033.BillNo," & _
                                         "SO033.ServiceType,SO033.ClassCode," & _
                                         "SO033.AccountNo From SO033,CD112" & strTableSO007 & " Where " & strChoose & _
                ...
                strSubQry2(6) = "SELECT CD004.Description,Sum(SO033.ShouldAmt) SumShouldAmt,Count(*) Counts,Count(Distinct SO033.Custid) CountCustid,Count(Distinct SO033.BillNo) CountBillNo " & _
                                     " From(" & _
                                         ...
                                         "SO033.ServiceType,SO033.ClassCode," & _
                                         "SO033.AccountNo From SO033,CD112" & strTableSO007 & " Where " & strChoose & _
                                         " Union all Select SO035.ShouldAmt,SO035.Custid,SO035.BillNo," & _
                                         "SO035.ServiceType,SO035.ClassCode,SO035.AccountNo From SO035,CD112" & strTableSO007 & " Where " & strChoose35 & _
                                   ") SO033,CD004" & strTableSO004 & IIf(strChooseSO002 = "", " Where ", strChooseSO002 & " And ") & "SO033.ClassCode=CD004.CodeNo " & strWhereSO004 & " Group by CD004.Description "
                ...
                strSubQry(7) = "SELECT SO017.Name,Sum(SO033.ShouldAmt) SumShouldAmt,Count(*) Counts,Count(Distinct SO033.Custid) CountCustid,Count(Distinct SO033.BillNo) CountBillNo,SO017.MduId  " & _
                                     " From(" & _
                                         "Select SO033.ShouldAmt,SO033.Custid,SO033.BillNo," & _
                                         "SO033.ServiceType,SO033.MduId,SO033.AccountNo From SO033,CD112" & strTableSO007 & " Where " & strChoose & _
                ...
                strSubQry2(7) = "SELECT SO017.Name,Sum(SO033.ShouldAmt) SumShouldAmt,Count(*) Counts,Count(Distinct SO033.Custid) CountCustid,Count(Distinct SO033.BillNo) CountBillNo,SO017.MduId  " & _
                                     " From(" & _
                                         ...
                                         "SO033.ServiceType,SO033.MduId,SO033.AccountNo From SO033,CD112" & strTableSO007 & " Where " & strChoose & _
                                         " Union all Select SO035.ShouldAmt,SO035.Custid," & _
                                         "SO035.BillNo,SO035.ServiceType,SO035.MduId," & _
                                         "SO035.AccountNo From SO035,CD112" & strTableSO007 & " Where " & strChoose35 & _
                                   ") SO033,SO017" & strTableSO004 & IIf(strChooseSO002 = "", " Where ", strChooseSO002 & " And ") & "SO033.MduId=SO017.MduId " & strWhereSO004 & " Group by SO017.Name,SO017.MduId  "
...
Private Sub subGim()
  On Error GoTo ChkErr
    ...
    '#7553 Add the condition of suite to screen by kin 2017/07/07
    Call SetgiMulti(gimSuite, "MduId", "Name", "SO202", "套房編號", "套房名稱")
...
'    End If
    ...
    strTable = strTable & ",SO001"
    strWhere = strWhere & " And SO033.CUSTID = SO001.CUSTID AND SO033.COMPCODE = SO001.COMPCODE "
    If Len(strChooseSO001 & "") > 0 Then
        strWhere = strWhere & " And " & strChooseSO001 & " "
    End If
    If optDail.Value Then
        '檢查地址依據
        ...
        strField = "SO033.CUSTID,SO033.BILLNO,SO033.RealStartDate,SO033.RealStopDate," & _
                    ...
                    "SO033.BpCode,SO033.BpName,Nvl(SO033.PayKind,0) PayKind,CD112.Description PayKindName "
        strView = "Select " & strField & " From SO033,SO004,CD112" & strTableSO007 & " Where "
        ...
        strView = "SELECT SO033.CUSTID,SO033.BILLNO,SO033.RealStartDate,SO033.RealStopDate," & _
                  ...
                  "SO033.BpCode,SO033.BpName,SO033.PayKind," & _
                  "SO033.PayKindName " & strFieldFaci & _
                      "From (" & strView & _
        ...
        If chkFaciName.Value = 1 Then
            ...
            If chkFaciUse.Value = 1 Then
                strView = "Select distinct SO033.Custid,SO033.BillNo,SO004.FaciName,SO004.BuyName,SO004.PRDate,SO004.FaciSno,SO004.CMBaudRate From CD112,SO033,SO004" & strTable & " Where SO033.Custid=SO004.Custid And  SO033.FaciSeqNo=SO004.SEQNo And SO004.InstDate is Not Null And SO004.PRDate is Null And " & strChoose & strWhere & strChooseSO004
            Else
                strView = "Select distinct SO033.Custid,SO033.BillNo,SO004.FaciName,SO004.BuyName,SO004.PRDate,SO004.FaciSno,SO004.CMBaudRate From CD112.SO033,SO004" & strTable & " Where SO033.Custid=SO004.Custid And SO033.FaciSeqNo=SO004.SEQNo And " & strChoose & strWhere & strChooseSO004
            End If
...
Private Sub toExcel(ByVal strSQL As String)
  On Error GoTo ChkErr
    Dim rsExcel As New ADODB.Recordset
      RptToTxt RptName("SO5210", "E"), , strSQL, strChooseString, _
               , , strGroupName, , , garyGi(19) & "\SO5210", False
      If Not Get_RS_From_Txt(garyGi(19), "SO5210.txt", rsExcel) Then blnExcel = False: Exit Sub
      Call UseProperty(rsExcel, "每月未繳費客戶明細表", "第一頁", , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , strChooseString)
      blnExcel = False
