...
Private Sub toExcel(ByVal strSQL As String, strSubQry() As String)
  On Error GoTo ChkErr
    ...
    RptToTxt RptName("SO5570", "E"), , strSQL, , , , strGroupName, , , garyGi(19) & "\SO5570", , , strSubQry(0), strSubQry(1)
    If Not Get_RS_From_Txt(garyGi(19), "SO5570.txt", rsExcel) Then blnExcel = False: Exit Sub
    For intFor = 0 To UBound(strSubQry)
    ...
    Call UseProperty(rsExcel, "無週期性收費項目客戶報表", "第一頁", , , rsSubExcel(0), "服務區,統計客戶數", rsSubExcel(1), "行政區,統計客戶數", _
                        , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , strChooseString)
    blnExcel = False
