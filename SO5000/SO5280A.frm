...
Private Sub subChoose()
  ...
  'GiMulti
    ...
    If gimCardCode.GetQryStr <> "" Then Call subAnd("SO002A.CardName " & gimCardCode.GetDescStr): blnSO002A = True
  ...
  '大樓編號
    ...
    If gimPayType.GetQryStr <> "" Then
        Call subAnd("Nvl(SO003.PayKind,0) " & gimPayType.GetQryStr)
    End If
  'GiList
  ...
  '是否統計免收費客戶
    ...
    If blnSO002A Then
        ...
        strChoose = strChoose & " And SO003.Custid=SO002A.Custid And SO003.AccountNo=SO002A.AccountNo"
    End If
...
Private Sub toExcel(ByVal strSQL As String)
  On Error GoTo ChkErr
    ...
    RptToTxt RptName("SO5280", "5"), , strSQL, strChooseString, , , strGroupName, , , garyGi(19) & "\SO5280"
    If Not Get_RS_From_Txt(garyGi(19), "SO5280.txt", rsExcel) Then blnExcel = False: Exit Sub
     '#7074 To Add a choice-condition parameter into excel print function by Kin 2015/09/09
    Call UseProperty(rsExcel, "收費到期客戶數統計明細表", "第一頁", _
                    , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , strChooseString)
    blnExcel = False
  ...
  On Error GoTo ChkErr
    ...
    Dim strViewSql As String
      ...
      strViewSql = "Create View " & strViewName & " as (" & _
                   "Select " & strUseIndex & " SO001.CUSTID,SO001.CUSTNAME," & _
                   "SO001.TEL1,SO001.CLASSNAME1,SO002.INSTTIME,SO003.CLCTDATE," & _
                   "SO003.PERIOD," & _
                   "SO003.AMOUNT,SO003.STARTDATE,SO003.STOPDATE,SO014.ServName," & _
                   "SO014.ClctEn,SO014.ClctName,SO014.MDUId,SO014.MDUName," & _
                   "SO001.CHARGEADDRESS,SO001.CustNote,SO014.AddrSort," & _
                   "SO001.ServCode,SO001.ServArea,SO014.AREANAME,SO014.AREACODE," & _
                   "SO001.CLCTAREACODE,SO001.CLCTAREANAME,SO014.Address," & _
                   "so003.CitemName,SO001.TEL2,SO001.TEL3," & _
                   "SO001.CHARGENOTE,Nvl(SO003.PayKind,0) PayKind " & _
                   strTable & strChoose & ")"
