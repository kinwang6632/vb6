...
Private Sub cmdTEST_Click()
    ...
    Dim strErrMsg As String
        ...
        '*************************無UI*************************
        strQry = " A.CustId = 58920 And A.CompCode = 11  And A.FaciSNo is not null And FaciCode In (Select CodeNo From CD022 Where RefNo in (3,4)) And A.PRDate is null "
        strQry = "Select A.* From SO004 A Where FaciSNo='168296929411'"
        strQry2 = "Select A.* From SO004 A Where FaciSNo='012201206030000033'"
        If rsData.State = adStateOpen Then rsData.Close
        rsData.CursorLocation = adUseClient
        rsData.Open strQry, cnn, adOpenKeyset, adLockOptimistic
        rs2.CursorLocation = adUseClient
        rs2.Open strQry2, cnn, adOpenKeyset, adLockOptimistic
        Dim obj2 As New csVODcontrol.clsExeCommand
        blnReturn = obj2.ExeVodCommand(cnn, rsData, "A6", garyGi(), , , , , , "201407ID0006721", , , , , , , rs2, strResult, strFaulReason, strErrMsg)
        'Set obj = CreateObject("csVODcontrolNoUI.clsExeCommand")
        'Dim obj As New csVODcontrolNoUI.clsExeCommand
'        Dim strUId As String
'        garyGi(10) = "C:\TEST\"
'        blnReturn = obj.ExeVodCommand(cnn, rsData, "A1", garyGi(), , , , , , , , , , , , , , strResult, strFaulReason, strErrMsg, , , , strUId)
'        If blnReturn Then
