...
Private Sub cmdOK_Click()
  On Error GoTo chkErr
    ...
    '7027 Start recording print time by kin 2016/03/21
    ReadyGoPrint
    blnUnload = False
...
Private Sub subChoose()
  ...
  Dim rsLength As New ADODB.Recordset
    ...
    '#7049 改取CD068A.CitemCode By Kin 2015/07/09
    If cboBillHeadFmt.Visible Then
        If gimCitemCode.GetQryStr <> "" Then subAnd ("A.CitemCode In (Select CitemCode From " & GetOwner & "CD068A " & _
    ...
    Dim intPara23 As Integer
     ...
     gilCompCode.Query_Description
        ...
        If intPara24 = 1 Then
            ...
            '  用媒體入帳才Lock
            If intPara23 = 2 Then gimCitemCode.IsReadOnly = False
            ...
            lblServiceType.Visible = False
             '#7049 如果多帳號依據有顯示，則不收費項目不能選擇 By Kin 2015/07/08
