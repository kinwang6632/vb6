        ...
        If Not rsSo3311E.EOF Then
            ...
            Do While Not rsSo3311E.EOF
                With rsSo3311
                    ...
                    End If
                    .Fields("BankCode") = GetFieldValue(rsSo3311E, "BankCode")
                    .Fields("BankName") = GetFieldValue(rsSo3311E, "BankName")
                    .Fields("AccountNo") = GetFieldValue(rsSo3311E, "AccountNo")
                    .Fields("InvSeqNo") = GetFieldValue(rsSo3311E, "InvSeqNo")
                    .Update
...
Private Sub txtBillNo_Change()
    ...
    '                '若輸入值非B單格式 (而是臨時單或印單序號格式), 則根據取出之收費資料第一筆的客戶編號, 至客戶基本資料檔取
        ...
        End If
        '********************************************************************
        '#7713 檢查單據UCCode是否為參考為3 By Kin 2018/03/02
        If chkREF3 Then
            ...
            Do While Not rsSo3311E.EOF
                With rsSo3311
                    ...
                    If Len(rsSo3311E("NextAmt")) > 0 Then
                        .Fields("NextAmt") = rsSo3311E("NextAmt")
                    End If
                    '#7339 fill out those datafieds from so033 by kin 2016/11/08
                    .Fields("BankCode") = GetFieldValue(rsSo3311E, "BankCode")
                    .Fields("BankName") = GetFieldValue(rsSo3311E, "BankName")
                    .Fields("AccountNo") = GetFieldValue(rsSo3311E, "AccountNo")
                    .Fields("InvSeqNo") = GetFieldValue(rsSo3311E, "InvSeqNo")
