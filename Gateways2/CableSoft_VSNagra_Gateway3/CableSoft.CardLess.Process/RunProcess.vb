...
Public Class RunProcess
    ...
    Public Sub RunProcess()
        Try
            ...
            End If
            If Not CableSoft.CardLess.XMLFileIO.XmlFileIO.Create_Transaction_Number_File() Then
                Throw New Exception("建立Transaction_Number_File失敗！")
                Exit Sub
            End If
            ...
            For i As Integer = 0 To tbServer.Rows.Count - 1
                SckClient(i) = New Client(tbNagra.Copy, tbErrorList.Copy,
                                          tbServer.Rows(i).Item("SourceId"),
                                          tbServer.Rows(i).Item("DestId").ToString,
                                          tbServer.Rows(i).Item("MoppId").ToString)
