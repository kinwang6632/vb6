...
Public NotInheritable Class GetwaySys
    ...
    Private Const FUseCompanyName As String = "UseCompany"
    Private Const FPushServerParaSetName As String = "PushServerParaSet"
    Private Const fSocketSourceId As String = "SocketSourceId"
    Private Const fPushServerUrls As String = "PushServerUrls"
    ...
    Public Property DBPool() As Int32
        ...
        End Set
    End Property
    Public Shared Function ReadTable(ByVal aMDBFile As String,
                                                ByVal aMDBPassword As String,
                                                ByVal aMDBTableName As String) As DataTable
        Try
            Return CableSoft.GateWay.Common.MDBCommon.ReadMDBDataTable(aMDBFile, aMDBPassword, aMDBTableName, Nothing)
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    End Function

    Public Shared Function ReadErrorCode(ByVal aMDBFile As String, ByVal aMDBPassword As String) As DataTable
        Try
            Return CableSoft.GateWay.Common.MDBCommon.ReadMDBDataTable(aMDBFile, aMDBPassword, FComparedErrorName, Nothing)
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    End Function
    Public Shared Function ReadSystemIO(ByVal aMDBFile As String, ByVal aMDBPassword As String) As DataTable
        Try
            Return CableSoft.GateWay.Common.MDBCommon.ReadMDBDataTable(aMDBFile, aMDBPassword, FSysTable, Nothing)
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    End Function
    Public Shared Function ReadSO(ByVal aMDBFile As String, ByVal aMDBPassword As String) As DataTable
        Try
            ...
            Return CableSoft.GateWay.Common.MDBCommon.ReadMDBDataTable(aMDBFile, aMDBPassword, FDatabase, Nothing)
            'Return CableSoft.GateWay.Common.MDBCommon.ReadMDBDataTable(aMDBFile, aMDBPassword, FDatabase)
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try

    End Function
    Public Shared Function ReadSocketSourceId(ByVal aMDBFile As String, ByVal aMDBPassword As String) As DataTable
        Try
            Return CableSoft.GateWay.Common.MDBCommon.ReadMDBDataTable(aMDBFile, aMDBPassword, fSocketSourceId, Nothing)
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    End Function
    Public Shared Function ReadUseComp(ByVal aMDBFile As String, ByVal aMDBPassword As String) As DataTable
        Try
            Return CableSoft.GateWay.Common.MDBCommon.ReadMDBDataTable(aMDBFile, aMDBPassword, FUseCompanyName, Nothing)
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    End Function
    Public Shared Function ReadPushServerParaSet(ByVal aMDBFile As String, ByVal aMDBPassword As String) As DataTable
        Try
            Return CableSoft.GateWay.Common.MDBCommon.ReadMDBDataTable(aMDBFile, aMDBPassword, FPushServerParaSetName, Nothing)
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    End Function
    Public Shared Function ReadPushServerUrl(ByVal aMDBFile As String, ByVal aMDBPassword As String) As DataTable
        Try
            Return CableSoft.GateWay.Common.MDBCommon.ReadMDBDataTable(aMDBFile, aMDBPassword, fPushServerUrls, Nothing)
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    ...
    Public Shared Function ReadNagraParaSet(ByVal aMDBFile As String, ByVal aMDBPassword As String) As DataTable
        Try
            Return CableSoft.GateWay.Common.MDBCommon.ReadMDBDataTable(aMDBFile, aMDBPassword, FNagraParaSetName, Nothing)
        Catch ex As Exception
            Throw New Exception(ex.Message)
        End Try
    End Function
    ...
    Private Function ReadDataCrypt(ByVal aContext As String, ByVal blnEncrypt As Boolean) As String
        ...
        End If
    End Function
    'Default Push Server 設定參數值
    Public Shared Function DefaultPushServerPara(ByVal aMDBFile As String, _
        ...
        Try
            ...
            rw("PushServerUrl") = "http://127.0.0.1"
            rw("PushServerUrlMethod") = "POST"
            rw("PushServerUrlTimeOut") = "30"
            rw("PushServerDuration") = "30"
            rw("PushServerRepeat") = "2"
            rw("CmdErrSndMail") = "0"
            rw("NoneResumeCnt") = "0"
    ...
    Public Shared Function DefaultSystem(ByVal aMDBFile As String, ByVal aMDBPassword As String, _
        ...
        Try
            ...
            rw("ShowResource") = "0"
            rw("UseHotKey") = "0"
            rw("AutoConnectTime") = "100"
            rw("ReadDataTime") = "100"
            rw("ProcessNumber") = "100"
            rw("ShowDataCount") = "200"
            rw("ClearDataCount") = "20"
            rw("MaxThread") = "25"
            rw("DBPoolMaxNumber") = "100"
            rw("DBPoolMinNumber") = "0"
            rw("DBPoolLiveTime") = "100"
