...
Module mdlCommon
    ...
    Public Sub SetSysMsgString()
        Try
            ...
            FLstSysMsg.Add("Parent 讀取 Nagra 參數設定..")
    ...
    Public Function SetSO() As Boolean
        Try
            ...
            FSOTable = CableSoft.GateWay.SystemIO.GetwaySys.ReadUseComp(FMDBFile, FMDBPassword)
            If (FSOTable IsNot Nothing) AndAlso (FSOTable.Rows.Count > 0) Then
                ...
                For i As Int32 = 0 To FSOTable.Rows.Count - 1
                    ...
                    Dim Sid As String = "ABC"
                    Dim User As String = "CDE"
                    Dim Password As String = "FGH"
                    If Not String.IsNullOrEmpty(GetFieldValue(FSOTable.Rows(i), "DBSid")) Then
                        Sid = GetFieldValue(FSOTable.Rows(i), "DBSid")
                    End If
                    If Not String.IsNullOrEmpty(GetFieldValue(FSOTable.Rows(i), "DBUser")) Then
                        User = GetFieldValue(FSOTable.Rows(i), "DBUser")
                    End If
                    If Not String.IsNullOrEmpty(GetFieldValue(FSOTable.Rows(i), "DBPassword")) Then
                        Password = GetFieldValue(FSOTable.Rows(i), "DBPassword")
                    End If
                    ...
                    '
                    obj.CompID = GetFieldValue(FSOTable.Rows(i), "CompID")
                    obj.CompName = GetFieldValue(FSOTable.Rows(i), "CompName")
                    obj.ConnectionOK = False
                    FSOInfoList.Add(obj)

                Next
            Else
                Throw New Exception("未設定SID連線資訊")
            End If
            ...
            Else
                ...
                Try
                    ...
                    For aIndex As Int32 = 0 To aCMDInfo.NagraSendAndRecvMsg.Count - 1
                        ...
                        Select Case aCMDInfo.AllFieldsValue.Item("CMD_STATUS")
                            Case "S1", "S", "C"
                ...
                Try
                    ...
                    If trlParent IsNot Nothing Then
                        For i As Int32 = 0 To fFrom.TreLstInstruct.Columns.Count - 1
                            ...
                            If aCmdInfo.AllFieldsValue.ContainsKey(aFieldName.ToUpper) Then
                                    ...
                                    Else
                                        ...
                                        If aNote IsNot Nothing Then
                                            ...
                                            Else
                                                ...
                                                aNote.SetValue("WaitProc", FUseCompIndex.Item(aSO.CompID).WaitProcessNumber)
                                                aNote.SetValue("Procing", FUseCompIndex.Item(aSO.CompID).ProcessingNumber)
                                            End If
                                        End If
                                    End If
                                Else
