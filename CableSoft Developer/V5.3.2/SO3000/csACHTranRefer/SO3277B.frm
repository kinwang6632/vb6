...
Begin VB.Form frmSO3277B 
   Caption         =   "ACH轉帳扣款資料產生[SO3277B]"
   ClientHeight    =   3765
   ClientLeft      =   60
   ClientTop       =   390
   ClientWidth     =   8970
   Icon            =   "SO3277B.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   3765
   ScaleWidth      =   8970
...
Private Sub cmdOK_Click()
    ...
    End If
    If OpenFile(txtDataPath, 0, True) = False Then Exit Sub
...
'        If intPara24 = 1 Then
'            If rs("type") = 1 Then
'                strData = strData & GetString(rs("Billno"), 11, giLeft)
'                '單據編號 (65-75)
'                strData = strData & GetString("", 5, giLeft, True)
'                '保留欄位(76-80)
'                strData = strData & GetString(Left(rs("billno"), 4), 4, giLeft)
'            Else
'                strData = strData & GetString(GetBillNo_Old(rs("Billno")), 11, giLeft)
'                '單據編號 (65-75)
'                strData = strData & GetString("", 5, giLeft, True)
'                '保留欄位(76-80)
'                strData = strData & GetString(Left(Val(Left(rs("billno"), 6) - 191100), 4), 4, giLeft)
'            End If
'        Else
'            strData = strData & GetString(GetBillNo_Old(rs("Billno")), 11, giLeft)
'            '退件理由代號 (65-66)
...
'            strData = strData & GetString(Left(Val(Left(rs("billno"), 6) - 191100), 4), 4, giLeft)
'        End If
'        If rs("RealAmt") < 0 Then strData = strData & "-"
'        '如果收費資料金額小於0
