  ...
  try
    ...
    try
      ...
      begin
        ...
        aSoInfo.CriticalErrorCount := 0;
        aSoInfo.LastCriticalErrorTime := 0;
    ...
    begin
      try
        HighCmdEnv.AppendRecord( [
          ...
          FLbDES.DecryptString( DataReader.FieldByName( 'VOD_MOPP_ID' ).AsString )] );
...
begin
  ...
  if ( DataReader.IsEmpty ) then
    ...
    FFeedbackSo.CriticalErrorCount := 0;
    FFeedbackSo.LastCriticalErrorTime := 0;
  end;
...
begin
  ...
  try
    ...
    begin
      ...
      aSo.CriticalErrorCount := 0;
      aSo.LastCriticalErrorTime := 0;
...
begin
  ...
  begin
    ...
    DataReader.Parameters.ParamByName( '11' ).Value :=
      FLbDES.EncryptString( aNode.Texts[fmConfig.HighCmdTreeColumn11.ItemIndex] );
    try
      DataReader.ExecSQL;
    except
      on E: Exception do
