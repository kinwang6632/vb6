...
begin
  ...
  begin
    ...
    if Panel1.Controls[aIndex] is TCheckBox then
      Panel1.Controls[aIndex].Enabled:= CheckBox1.Checked
    else
      Panel1.Controls[aIndex].Enabled:=False;
  end;
  if not CheckBox1.Checked then X_ServiceTypeStrClick( X_CitemCodeStr );
  Button13.Enabled := CheckBox1.Checked;
  X_CitemCodeStr.Enabled := CheckBox1.Checked;
end;
...
begin
  if not CheckBox2.Checked then X_ServiceTypeStrClick( X_BundleProdCodeStr );
  Button15.Enabled := CheckBox2.Checked;
  X_BundleProdCodeStr.Enabled := CheckBox2.Checked;
end;
...
begin
  if not CheckBox3.Checked then X_ServiceTypeStrClick( X_PackageNoStr );
  Button2.Enabled := CheckBox3.Checked;
  X_PackageNoStr.Enabled := CheckBox3.Checked;
end;
...
begin
  ...
  begin
    ...
    EDT_DiscountCode.Text := ComboBox8.Items[ComboBox8.ItemIndex];
  end else
  begin
  ...
  EDT_DiscountCode.Enabled := CheckBox4.Checked;
  EDT_DiscountCodeStr.Enabled := CheckBox4.Checked;
end;
...
begin
  ...
  else if CheckBox1.Checked and (EDT_CitemCode.Items.Count<1) then
    begin
      cxPageControl1.ActivePageIndex := 1;
      WarningMsg('促銷產品：特定產品需有值');
      if Button13.CanFocus then Button13.SetFocus;
      Exit;
    end
  else if CheckBox2.Checked and (EDT_BundleProdCode.Items.Count<1) then
    begin
      cxPageControl1.ActivePageIndex := 1;
  ...
  else if CheckBox3.Checked and (EDT_PackageNo.Items.Count<1) then
    begin
      cxPageControl1.ActivePageIndex := 1;
  ...
  else if CheckBox4.Checked and ( EDT_DiscountCode.Text = EmptyStr ) then
    begin
      cxPageControl1.ActivePageIndex := 1;
...
begin
  ...
  CheckBox1.Checked:= ClientDataSet1.FieldByName('CitemCodeStr').AsString <> EmptyStr;
  ...
  CheckBox2.Checked:= ClientDataSet1.FieldByName('BPCodeStr').AsString <> EmptyStr;
  ...
  CheckBox3.Checked:= ClientDataSet1.FieldByName('PackageNoStr').AsString <> EmptyStr;
  ...
  CheckBox4.Checked:= ClientDataSet1.FieldByName('DiscountCodeStr').AsString <> EmptyStr;
  ...
  begin
    if ComboBox8.Items[I] = EDT_DiscountCode.Text then
    begin
...
begin
  ...
  begin
    ...
    ComboBox8.Items.Add(AdoQuery2.FieldByName('CODENO').AsString);
    AdoQuery2.Next;
  end;
  ADOQuery2.Close;
end;
...
begin
  EDT_DiscountCode.Text := ComboBox8.Items[EDT_DiscountCodeStr.ItemIndex];
end;
