...
constructor TfrmCD078B3_6.Create(aMode: TDML; aDataSet: TClientDataSet; aKeys: array of String);
begin
...
procedure TfrmCD078B3_6.FormCreate(Sender: TObject);
begin
  InitControls;
...
procedure TfrmCD078B3_6.FormShow(Sender: TObject);
begin
...
procedure TfrmCD078B3_6.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TfrmCD078B3_6.FormDestroy(Sender: TObject);
begin
  FSourceDataSet := nil;
...
procedure TfrmCD078B3_6.ButtonStateChange;
begin
...
procedure TfrmCD078B3_6.ClearEditor;
begin
...
function TfrmCD078B3_6.DataSetStateChange(const aMode: TDML): Boolean;
begin
  Result := True;
  case aMode of
    dmInsert:
...
procedure TfrmCD078B3_6.DataToEditor;
var
  aRankInfo: PRankInfo;
begin
...
function TfrmCD078B3_6.DataValidate: Boolean;
begin
  Screen.Cursor := crSQLWait;
  try
    Result := VdMustInput;
...
procedure TfrmCD078B3_6.DMLModeChange(aMode: TDML);
begin
...
procedure TfrmCD078B3_6.EditorStateChange;
begin
  case FMode of
    dmBrowser:
      begin
...
function TfrmCD078B3_6.EditorToData: Boolean;
begin
...
function TfrmCD078B3_6.EditorToData(const aIndex: Integer): Boolean;
var
  aRankInfo: PRankInfo;
  aBookMark: TBookmark;
begin
...
procedure TfrmCD078B3_6.InternalCalcMonth;
var
...
procedure TfrmCD078B3_6.LinkKeyCodeNoPropertiesChange(Sender: TObject);
var
  aRankInfo: PRankInfo;
begin
...
procedure TfrmCD078B3_6.LinkKeyCodeNamePropertiesChange(Sender: TObject);
var
  aRankInfo: PRankInfo;
begin
...
procedure TfrmCD078B3_6.LinkKeyCodeNamePropertiesInitPopup(Sender: TObject);
begin
...
procedure TfrmCD078B3_6.PrepareRankDataSet;
begin
...
procedure TfrmCD078B3_6.UnPrepareRankDataSet;
begin
  RankDataSet.EmptyDataSet;
...
function TfrmCD078B3_6.VdMustInput: Boolean;
var
  aIndex: Integer;
...
function TfrmCD078B3_6.VdMonthBreak: Boolean;
var
...
function TfrmCD078B3_6.VdRateAndAmt: Boolean;
var
  aIndex: Integer;
...
procedure TfrmCD078B3_6.DeCompoundRankData;
var
  aIndex: Integer;
begin
...
function TfrmCD078B3_6.CompoundNullRankData(const aState: TDataSetState): String;
var
  aIndex: Integer;
  aStepNo: String;
begin
...
procedure TfrmCD078B3_6.CleanupRankPage;
var
  aIndex: Integer;
begin
...
procedure TfrmCD078B3_6.CleanupRankPage(const aIndex: Integer);
var
  aTab: TcxTabSheet;
begin
...
procedure TfrmCD078B3_6.AllocateEmptyRankInfo;
var
  aRankInfo: PRankInfo;
  aCaption: String;
  aTab: TcxTabSheet;
...
procedure TfrmCD078B3_6.AllocateFullRankInfo;
var
...
procedure TfrmCD078B3_6.AllocateNewRankInfo;
var
  aRankInfo : PRankInfo;
  aCaption: String;
  aTab: TcxTabSheet;
...
procedure TfrmCD078B3_6.FilterRankData(const aStepNo: String);
begin
  RankDataSet.DisableControls;
  try
...
procedure TfrmCD078B3_6.RankDataBindToArray;
begin
  FillChar( FMonMap, SizeOf( FMonMap ), Ord( False ) );
  RankDataSet.DisableControls;
  try
...
procedure TfrmCD078B3_6.MakeColumnEditMode;
begin
  if ( RankGrid.CanFocusEx ) then RankGrid.SetFocus;
  gvRank.Controller.EditingItem := gvRankColumn2;
end;
...
procedure TfrmCD078B3_6.MoveToLastRecord;
var
  aIndex: Integer;
begin
...
procedure TfrmCD078B3_6.RankDataSetAfterCancel(DataSet: TDataSet);
begin
  FMonMap[RankDataSet.FieldByName( 'RankLv' ).AsInteger] :=
    ( RankDataSet.FieldByName( 'Mon' ).AsString <> EmptyStr );
end;
...
procedure TfrmCD078B3_6.RankPageDrawTabEx(AControl: TcxCustomTabControl;
...
procedure TfrmCD078B3_6.RankPageChange(Sender: TObject);
var
  aRankInfo: PRankInfo;
begin
  Screen.Cursor := crSQLWait;
...
procedure TfrmCD078B3_6.gvRankCustomDrawCell(Sender: TcxCustomGridTableView;
  ACanvas: TcxCanvas; AViewInfo: TcxGridTableDataCellViewInfo;
  var ADone: Boolean);
var
  aItem: TcxGridDBBandedColumn;
...
procedure TfrmCD078B3_6.gvRankColumn2PropertiesChange(Sender: TObject);
var
...
procedure TfrmCD078B3_6.gvRankColumn2PropertiesEditValueChanged(
  Sender: TObject);
var
  aInnerEdit: TcxMaskEdit;
  aIndex: Integer;
begin
  ...
  aIndex := RankDataSet.FieldByName( 'RankLv' ).AsInteger;
  FMonMap[aIndex] := ( aInnerEdit.EditingText <> EmptyStr );
  { 若該多階方案代碼, 非負項, 則不使用折扣率, 用FEnableLinkKey 來判斷 }
  if ( FEnableLinkKey ) then
...
procedure TfrmCD078B3_6.gvRankColumn4PropertiesEditValueChanged(Sender: TObject);
var
  aInnerEdit: TcxMaskEdit;
...
procedure TfrmCD078B3_6.gvRankColumn6PropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
...
procedure TfrmCD078B3_6.gvRankEditing(Sender: TcxCustomGridTableView;
  AItem: TcxCustomGridTableItem; var AAllow: Boolean);
var
...
procedure TfrmCD078B3_6.edtDescriptionPropertiesChange(Sender: TObject);
var
  aRankInfo: PRankInfo;
begin
  aRankInfo := PRankInfo( RankPage.Tabs.Objects[RankPage.ActivePageIndex] );
...
procedure TfrmCD078B3_6.chkMasterSalePropertiesChange(Sender: TObject);
var
  aRankInfo: PRankInfo;
  aIndex: Integer;
  aOldStepNo: String;
...
procedure TfrmCD078B3_6.actCancelExecute(Sender: TObject);
begin
  DMLModeChange( dmCancel );
  Self.Close;
end;
...
procedure TfrmCD078B3_6.actSaveExecute(Sender: TObject);
begin
...
procedure TfrmCD078B3_6.DeleteRankData(const aStepNo: String);
var
...
procedure TfrmCD078B3_6.btnDelRnakClick(Sender: TObject);
var
  aRankInfo: PRankInfo;
begin
  aRankInfo := PRankInfo( RankPage.Tabs.Objects[RankPage.ActivePageIndex] );
...
procedure TfrmCD078B3_6.btnAddRankClick(Sender: TObject);
var
  aNewStepNo: String;
begin
  Screen.Cursor := crSQLWait;
...
function TfrmCD078B3_6.SaveData: Boolean;
...
procedure TfrmCD078B3_6.ReCaptionTabSheet;
var
  aIndex: Integer;
  aCaption: String;
begin
...
procedure TfrmCD078B3_6.InitControls;
begin
...
procedure TfrmCD078B3_6.SetEnableLinkKey(const AEnabled: Boolean);
begin
...
procedure TfrmCD078B3_6.gvRankColumn11GetCellHint(
...
procedure TfrmCD078B3_6.gvRankColumn11PropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var
  aData: String;
  aRow: TcxGridDataRow;
