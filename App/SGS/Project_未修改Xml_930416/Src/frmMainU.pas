...
begin
    ...
    //取得監管平台 Request
    sL_RequestInfo := RequestInfo.Params.GetText;
    dtmMain.savetofile(sL_RequestInfo,'c:\RequestInfo.txt');
...
begin
  ...
  //CA產品資訊之查詢(CAProductQuery)
            ...
            sL_TotalChannelNum := IntToStr(nL_TotalProductNum);
...
function TfrmMain.returnZipXML(sI_QueryType,sI_XmlFilePath,sI_ResponXml, sI_CompCode,
  ...
  sI_FirstDate, sI_HandleEDateTime, sI_RetCode, sI_Msg: String;
  nI_TotalExecCounts: Integer): WideString;
var
    L_MsgRootNode,L_ReturnChildNode,L_MasterChildNode,L_DetailChildNode,L_SubDetailChildNode  : IXmlNode;
...
var
    L_MsgNodeList : IDOMNodeList;
    sI_TmpXmlFilePath,sI_QueryType : String;
    ii,jj : Integer;
begin
    sI_TmpXmlFilePath := 'D:\app\SGS\Project\Bin\歷史資料\20030819_SMS_ICCardQueryR.xml';
    getXMLDocument.LoadFromFile(sI_TmpXmlFilePath);
