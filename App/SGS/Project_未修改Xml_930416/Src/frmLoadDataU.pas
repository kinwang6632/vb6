...
type
  ...
  TfrmLoadData = class(TForm)
    ...
    procedure btnAddToSO453Click(Sender: TObject);
  private
...
//*************************************
    ...
    begin
      ...
      begin
        ...
        frmMain.returnQueryXML(sL_QueryType,sL_Table,sL_CmdSeq,sI_CompCode,sL_Version,sL_QueryDateTime,
...
procedure TfrmLoadData.btnAddToSO453Click(Sender: TObject);
var
    sL_SQL : String;
    L_AdoQry : TADOQuery;
begin
    //sL_SQL := 'SELECT * FROM WHERE SO453 WHERE HANDLEEDATETIME=TO_DATE(''2003/01/01 23:59:59'',''YYYY/MM/DD HH24:MI:SS'')';
    //L_AdoQry := dtmMain.runSQL(SELECT_MODE,sI_CompCode,sL_SQL);
