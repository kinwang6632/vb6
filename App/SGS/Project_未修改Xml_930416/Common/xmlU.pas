...
class function TMyXML.createRootNode(I_XMLDocument: TXMLDocument;
  sI_NodeName, sI_NodeValue: String): String;
var
    sL_Result : STring;
begin
    sL_Result := '';
    ...
    begin
      ...
      sL_Result := '此 XML 已經有 Root Node 了';
    result := sL_Result;
...
begin
    ...
    begin
      ...
      sI_Result := dtmMain.getLanguageSettingInfo('common_Msg_2_Content');//此 XML 已經有 Root Node 了
