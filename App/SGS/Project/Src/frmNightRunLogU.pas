...
begin
    ...
    begin
      ...
      if MessageDlg(dtmMain.getLanguageSettingInfo('frmNightRunLog_Msg_8_Content'), mtConfirmation, [mbYes, mbNo], 0) = mrYes then
        frmMain.StartNightRunProcess(false,sL_CompCode,sL_ModeType,sL_QueryStartDate,sL_QueryStopDate, chbCombineData.Checked);

      {
      if chbCombineData.Checked then
      begin
        frmMain.combineData(sL_CompCode,sL_ModeType,sL_QueryStartDate,sL_QueryStopDate);
      end;
      }
    end;
end;
