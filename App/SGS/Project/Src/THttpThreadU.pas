...
var
    ...
    sL_TotalICCardNum,sL_TotalSubNum,sL_TotalProductNum,sL_TotalChannelNum,sL_XmlFilePath : String;
begin
    ...
    //顯示要傳送指令
    frmMain.showSendMsgUI(sL_CmdSeq,sL_DstMsgID,sL_DstCode,sL_CompCode,sL_HandleEDateTime,
    ...
    begin
      ...
      sL_ResponXml := frmMain.returnQueryXML(false, sL_QueryType,sL_Table,sL_CmdSeq,sL_CompCode,sL_Version,sL_QueryDateTime,
      ...
      sL_XmlFilePath := dtmMain.getRealFilePath(sL_CompCode,sL_InstQuery,sL_QueryType,sL_HandleEDateTime,false);
