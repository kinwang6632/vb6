...
type
  ...
  private
    ...
    sG_CustID,sG_ChargeDate,sG_BillID,sG_CustID2,sG_ChargeDate2,sG_BillID2,sG_QueryType : String;
...
//      sGMaxSeq := EmptyStr;
      if rdbCustID.Checked then
      begin
        fG_Counts := dtmMainJ.getInv016Data(QUERY_TYPE_CUSTID,sG_CustID,sG_CustID2,sG_CompID,sG_StartChargeDate,sG_EndChargeDate,sGMinSeq,sGMaxSeq,fG_SaleAmount,fG_TaxAmount,fG_InvAmount);
