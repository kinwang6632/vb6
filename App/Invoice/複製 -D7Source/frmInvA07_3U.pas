...
uses
  ...
  ExtCtrls, DBClient, ADODB, Provider;
  ...
  begin
    ...
    aDataSet.SQL.Text := Format(
      ...
      [IDENTIFYID1, IDENTIFYID2,
       ...
       FormatDateTime('YYYYMMDD HHMMSS',aSysDate),
       dtmMain.getLoginUser, aAllowanceNo,cdsMaster.FieldByName( 'PaperNo').AsString ] );
...
begin
  ...
  try
    ...
    begin
      MessageDlg( '折讓金額大於發票金額！' + aMsg,mtWarning,[mbYes],0);
  ...
  try
    ...
    begin
      ...
      begin
        ...
        aMsg := Format(#10+#13+ aMsg + '折讓單號 : %s [ 金額 %s ]' ,
