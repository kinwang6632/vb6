...
type
  TfrmInvD07_1 = class(TForm)
    ...
    procedure XImportClick(Sender: TObject);
  private
...
procedure TfrmInvD07_1.XImportClick(Sender: TObject);
  var result : Boolean;
begin
  if dlgOpen1.Execute then
  begin
    result := importCSV(dlgOpen1.FileName);
  end;


end;

function TfrmInvD07_1.importCSV(csvFileName: String): Boolean;
