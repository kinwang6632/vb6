object dtmMainJ: TdtmMainJ
  ...
  object cdsChargeDetailExcel: TClientDataSet
    ...
    object cdsChargeDetailExcelUploadFlag: TStringField
      FieldName = 'UploadFlag'
    end
    object cdsChargeDetailExcelINVOICEKIND: TStringField
      FieldName = 'INVOICEKIND'
    end
    object cdsChargeDetailExcelGIVEUNITDESC: TStringField
      FieldName = 'GIVEUNITDESC'
      Size = 50
    end
    object cdsChargeDetailExcelISGIVE: TStringField
      FieldName = 'ISGIVE'
    end
    object cdsChargeDetailExcelFixFlag: TStringField
      FieldName = 'FixFlag'
      Size = 30
    end
  ...
  object adoQrySelectInv017: TADOQuery
    ...
    object adoQrySelectInv017UNITPRICE: TCurrencyField
    ...
    object adoQrySelectInv017TAXAMOUNT: TCurrencyField
      DisplayLabel = #31237#38989
      FieldName = 'TAXAMOUNT'
    end
    object adoQrySelectInv017TOTALAMOUNT: TCurrencyField
    ...
    object adoQrySelectInv017CHARGEEN: TStringField
      DisplayLabel = #25910#36027#20154#21729
      FieldName = 'CHARGEEN'
    end
  end
  ...
  object cdsSelectInv016: TClientDataSet
    ...
    object cdsSelectInv016CustId: TIntegerField
    ...
    object cdsSelectInv016SaleAmount: TIntegerField
      DisplayLabel = #37559#21806#38989
      FieldName = 'SaleAmount'
    end
    object cdsSelectInv016TaxAmount: TIntegerField
      DisplayLabel = #31237#38989
      FieldName = 'TaxAmount'
    end
    object cdsSelectInv016InvAmount: TIntegerField
      DisplayLabel = #30332#31080#37329#38989
      FieldName = 'InvAmount'
    end
  ...
  object adoComm: TADOQuery
    CacheSize = 1000
    Connection = dtmSO.SOConnection
    Parameters = <>
    Prepared = True
    Left = 516
    Top = 406
  end
  object adoInv045Code: TADOQuery
    Connection = dtmMain.InvConnection
    Parameters = <>
    Left = 274
    Top = 440
