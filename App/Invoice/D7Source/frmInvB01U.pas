...
type
  TfrmInvB01 = class(TForm)
    ...
    Label17: TLabel;
    medA0401File: TMaskEdit;
    btnA0401: TButton;
    Label18: TLabel;
    medA0501File: TMaskEdit;
    btnA0501: TButton;
    Label19: TLabel;
    MaskEdit2: TMaskEdit;
    Button2: TButton;
    Label20: TLabel;
    medB0301File: TMaskEdit;
    btnB0301: TButton;
    Label21: TLabel;
    medB0401File: TMaskEdit;
    btnB0401: TButton;
    lbl1: TLabel;
    medE0402File: TMaskEdit;
    btnE0402: TButton;
    lbl2: TLabel;
    medC0701File: TMaskEdit;
    btnC0701: TButton;
    lbl3: TLabel;
    medX0401notify: TcxMaskEdit;
    ...
    procedure btnA0401Click(Sender: TObject);
    procedure btnA0501Click(Sender: TObject);
    procedure btnB0301Click(Sender: TObject);
    procedure btnB0401Click(Sender: TObject);
    procedure btnE0402Click(Sender: TObject);
    procedure btnC0701Click(Sender: TObject);
  private
...
begin
     ...
     begin
       ...
       begin
          ...
          { 第四頁籤 }
          {#6262 增加設定頁籤 By Kin 2012/06/25}
          btnA0401.Enabled := True;
          btnA0501.Enabled := True;
          btnB0301.Enabled := True;
          btnB0401.Enabled := True;
          btnE0402.Enabled := True;
          btnC0701.Enabled := True;
          medX0401notify.Properties.ReadOnly := False;
       end
       else
       begin
          ...
          { 第四頁籤 }
          {#6262 增加設定頁籤 By Kin 2012/06/25}
          btnA0401.Enabled := False;
          btnA0501.Enabled := False;
          btnB0301.Enabled := False;
          btnB0401.Enabled := False;
          btnE0402.Enabled := False;
          btnC0701.Enabled := False;
          medX0401notify.Properties.ReadOnly := True;
       end;
...
var
  ...
  A0401FilePath,A0501FilePath,B0301FilePath,B0401FilePath,E0402FilePath,C0701FilePath,aX0401Notify: String;
begin
    if sI_InvParam <> '' then
    begin
      ...
      {#6600 增加E0402上傳路徑 By Kin 2013/10/02}
      try
        ...
        A0401FilePath := TMyXML.getAttributeValue(aNodeList.Nodes[1],'A0401FilePath');
        A0501FilePath := TMyXML.getAttributeValue(aNodeList.Nodes[1],'A0501FilePath');
        B0301FilePath := TMyXML.getAttributeValue(aNodeList.Nodes[1],'B0301FilePath');
        B0401FilePath := TMyXML.getAttributeValue(aNodeList.Nodes[1],'B0401FilePath');
        E0402FilePath := TMyXML.getAttributeValue(aNodeList.Nodes[1],'E0402FilePath');
        C0701FilePath := TMyXML.getAttributeValue(aNodeList.Nodes[1],'C0701FilePath');
        aX0401Notify := TMyXML.getAttributeValue(aNodeList.Nodes[1],'X0401notify');
        ...
        medEInvoiceFilePath.Text := EmptyStr;
        medA0401File.Text := A0401FilePath;
        medA0501File.Text := A0501FilePath;
        medB0301File.Text := B0301FilePath;
        medB0401File.Text := B0401FilePath;
        medE0402File.Text := E0402FilePath;
        medC0701File.Text := C0701FilePath;
        medX0401notify.Text := aX0401Notify;
...
begin
    ...
    begin
      ...
      {#6262 增加各個上傳路徑 By Kin 2012/06/25}
      {#6600 增加E0402路徑 By Kin 2013/10/02}
      A0401FilePath := Trim( medA0401File.Text );
      A0501FilePath := Trim( medA0501File.Text );
      B0301FilePath := Trim( medB0301File.Text );
      B0401FilePath := Trim( medB0401File.Text );
      E0402FilePath := Trim( medE0402File.Text );
      C0701FilePath := Trim( medC0701File.Text );
      ...
      aPrintZeroTax := 'N';
      aX0401Notify := '0';
      if Trim( medX0401notify.Text ) <> '' then
      begin
        aX0401Notify := medX0401notify.Text;
      end;
      ...
      aInvParam := '<?xml version="1.0" encoding="Big5" ?>' +
                     ...
                     'A0401FilePath="' + A0401FilePath + '" ' +
                     'A0501FilePath="' + A0501FilePath + '" ' +
                     'B0301FilePath="' + B0301FilePath + '" ' +
                     'B0401FilePath="' + B0401FilePath + '" ' +
                     'E0402FilePath="' + E0402FilePath + '" ' +
                     'C0701FilePath="' + C0701FilePath + '" ' +
                     'X0401notify="' + aX0401Notify +'" ' +
...
procedure TfrmInvB01.btnA0401Click(Sender: TObject);
  var aPath : String;
begin
  aPath := medA0401File.Text;
  if SelectDirectory( '電子發票拋檔路徑', EmptyStr, aPath ) then
    medA0401File.Text := aPath;
end;

procedure TfrmInvB01.btnA0501Click(Sender: TObject);
  var aPath : String;
begin
  aPath := medA0501File.Text;
  if SelectDirectory( '電子發票拋檔路徑', EmptyStr, aPath ) then
    medA0501File.Text := aPath;
end;

procedure TfrmInvB01.btnB0301Click(Sender: TObject);
  var aPath : String;
begin
  aPath := medB0301File.Text;
  if SelectDirectory( '電子發票拋檔路徑', EmptyStr, aPath ) then
    medB0301File.Text := aPath;
end;

procedure TfrmInvB01.btnB0401Click(Sender: TObject);
  var aPath : String;
begin
  aPath := medB0401File.Text;
  if SelectDirectory( '電子發票拋檔路徑', EmptyStr, aPath ) then
    medB0401File.Text := aPath;
end;

procedure TfrmInvB01.btnE0402Click(Sender: TObject);
 var aPath : String;
begin
  aPath := medE0402File.Text;
  if SelectDirectory( '電子發票拋檔路徑', EmptyStr, aPath ) then
    medE0402File.Text := aPath;
end;

procedure TfrmInvB01.btnC0701Click(Sender: TObject);
  var aPath : String;
begin
   aPath := medC0701File.Text;
  if SelectDirectory( '電子發票拋檔路徑', EmptyStr, aPath ) then
    medC0701File.Text := aPath;
end;
