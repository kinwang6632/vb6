...
Type
  ...
  public
    ...
    class function GetPureDateStr(dI_Date:TDate):String;overload;
    class function GetPureDateStr(dI_Date:TDate; sI_Sep:String):String;overload;
    class function GetPureTimeStr(dI_Date:TDate; sI_Sep:String):String;overload;    
    class function GetPureDateTimeStr(dI_Date:TDate; sI_DaySep, sI_TimeSep:String):String;overload;        
    class function GetPureDate(dI_Date:TDate):TDate;
    class function TransNumMonthToEngMonth(nI_NumMnth : Integer):String;
    class function IsDateStr(asSrc:String;Sep:String):Boolean;
...
class function TUdateTime.IsDateStr(asSrc: String;Sep:String): Boolean;
var
...
begin
  ...
  Result := nL_YDiffer * 12 + nL_MDiffer + 1;
end;
...
class function TUdateTime.GetPureDateStr(dI_Date: TDate;
  sI_Sep: String): String;
var
    wL_Year,wL_Month,wL_Day : Word;
begin
     DecodeDate(dI_Date,wL_Year,wL_Month,wL_Day);
     Result := Format('%.4d%s%.2d%s%.2d',[wL_Year,sI_Sep,wL_Month,sI_Sep,wL_Day]);
end;
...
class function TUdateTime.GetPureDateTimeStr(dI_Date: TDate; sI_DaySep,
  sI_TimeSep: String): String;
var
    wL_Year,wL_Month,wL_Day : Word;
...
begin
     ...
     Result := Format('%.4d%s%.2d%s%.2d %.2d%s%.2d%s%.2d',[wL_Year,sI_DaySep,wL_Month,sI_DaySep,wL_Day, wL_Hour,sI_TimeSep, wL_Min,sI_TimeSep, wL_Sec]);

end;

class function TUdateTime.GetPureTimeStr(dI_Date: TDate;
  sI_Sep: String): String;
var
    wL_Hour,wL_Min,wL_Sec, wL_MSec : Word;
begin
     DecodeTime(dI_Date,wL_Hour,wL_Min,wL_Sec, wL_MSec);
     Result := Format('%.2d%s%.2d%s%.2d',[wL_Hour,sI_Sep,wL_Min,sI_Sep,wL_Sec]);
end;

class function TUdateTime.ParseStrings(Strs, sI_Sep: string): TStringList;
var
  ii, jj : Integer ;
  slst : TStringList ;
begin
