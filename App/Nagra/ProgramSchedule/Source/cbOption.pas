...
type
  TfmOption = class(TForm)
    ...
    edtFtpAccount: TcxTextEdit;
    edtFtpPassword: TcxTextEdit;
    cxGroupBox8: TcxGroupBox;
    Label23: TLabel;
    Label24: TLabel;
    edtFtpWrapperSrc: TcxTextEdit;
    Label25: TLabel;
    edtFtpAsRunSrc: TcxTextEdit;
    edtFtpDexSrc: TcxTextEdit;
    Label26: TLabel;
    edtFtpDexBackup: TcxTextEdit;
    edtFtpWrapperBackup: TcxTextEdit;
    Label27: TLabel;
    Label28: TLabel;
    edtFtpAsRunBackup: TcxTextEdit;
...
uses cbUtilis, cbEmail, cbAppClass;
...
begin
  ...
  {}
  edtFtpServer.Text := EmptyStr;
  edtFtpAccount.Text := EmptyStr;
  edtFtpPassword.Text := EmptyStr;
end;
...
begin
  ...
  {}
  edtFtpServer.Text := ConfigModule.Param.FtpServer;
  edtFtpAccount.Text := ConfigModule.Param.FtpAccount;
  edtFtpPassword.Text := ConfigModule.Param.FtpPassword;
  {}
  edtFtpDexSrc.Text := ConfigModule.Param.FtpDexSrc;
  edtFtpDexBackup.Text := ConfigModule.Param.FtpDexBackup;
  edtFtpWrapperSrc.Text := ConfigModule.Param.FtpWrapperSrc;
  edtFtpWrapperBackup.Text := ConfigModule.Param.FtpWrapperBackup;
  edtFtpAsRunSrc.Text := ConfigModule.Param.FtpAsRunSrc;
  edtFtpAsRunBackup.Text := ConfigModule.Param.FtpAsRunBackup;
end;
...
begin
  ...
  {}
  ConfigModule.Param.FtpServer := edtFtpServer.Text;
  ConfigModule.Param.FtpAccount := edtFtpAccount.Text;
  ConfigModule.Param.FtpPassword := edtFtpPassword.Text;
  {}
  ConfigModule.Param.FtpDexSrc := edtFtpDexSrc.Text;
  ConfigModule.Param.FtpDexBackup := edtFtpDexBackup.Text;
  ConfigModule.Param.FtpWrapperSrc := edtFtpWrapperSrc.Text;
  ConfigModule.Param.FtpWrapperBackup := edtFtpWrapperBackup.Text;
  ConfigModule.Param.FtpAsRunSrc := edtFtpAsRunSrc.Text;
  ConfigModule.Param.FtpAsRunBackup := edtFtpAsRunBackup.Text;
  {}
