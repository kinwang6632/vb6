...
uses
  ...
  cxGrid, cxGridStrs, cxImageComboBox, IdBaseComponent, IdComponent,
  IdTCPConnection, IdTCPClient, IdFTP, dxSkinsCore, dxSkinsDefaultPainters,
  dxSkinscxPCPainter, dxSkinsdxBarPainter, dxSkinsdxDockControlPainter,
...
type
  TfmMain = class(TForm)
    ...
    procedure gvActionCustomDrawCell(
...
begin
  ...
  begin
    ...
    begin
      ...
      LogModule.ActionDataSet.Post;
      if FAutoScroll then
        gvAction.DataController.LocateByKey( aObj.KeyId );
    end;
  end;
end;
...
begin
  ...
  try
    ...
    if ( aLoaded ) then
    begin
      gvAction.Controller.GoToLast( False );
      Delay( COMM_DELAY * 3 );
...
procedure TfmMain.gvActionCustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
