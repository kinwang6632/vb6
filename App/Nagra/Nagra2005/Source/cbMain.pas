...
uses
  ...
  ImgList, ExtCtrls, StdCtrls, ComCtrls, CommCtrl, SyncObjs, DB, Math, IniFiles,
  { Indy 9.0.50 }
    ...
    try
      ...
      begin
        ...
        begin
          ...
          {$IFDEF DEBUG}
            CodeSite.SendWarning( Format( '%s has objects, job has not finished yet .', [aManagerName] ) );
          {$ENDIF}
        end;
      end;
