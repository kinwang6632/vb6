...
type
  ...
  private
    ...
    FLastCommunicationTickCount: Cardinal;
...
begin
  ...
  FLastCommunicationTickCount := GetTickCount;
end;
...
begin
  ...
  {$IFDEF DEBUG}
    ...
    CodeSite.EnterMethod( 'FeedbackRecv-ExtractBuffer' );
  {$ENDIF}
  ...
  {$IFDEF DEBUG}
    CodeSite.ExitMethod( 'FeedbackRecv-ExtractBuffer' );
    CodeSite.AddSeparator;
  {$ENDIF}
end;
