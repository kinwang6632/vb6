...
begin
    if (G_ListItem<> nil) and (G_ListItem.SubItems<>nil)then
    begin
...
//               nL_Pos := L_ListItem.Index;
               ...
               begin
                 ...
                 if Assigned(frmMain.G_HandleUIThread) and (frmMain.G_HandleUIThread<>nil) then
                 begin
                   {
                   self.sG_ErrorCode := sI_ErrorCode;
                   self.sG_ErrorMsg := sI_ErrorMsg;
                   }
