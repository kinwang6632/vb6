  ...
  //showmessage('dL_ExecDateTime  ' + DateTimeToStr(dL_ExecDateTime));
            ...
            begin
              ...
              if bL_EquipExist then
                showmessage('存在 ' + sL_SeqNo)
              else
                showmessage('不存在 ' + sL_SeqNo);
              }
...
//showmessage(sL_TmpXmlFileName);
  ...
  {jackal1001
            ...
            begin
              ...
              //sI_Msg := NO_AVAILABLE_QUERY_COMP + '  公司別=' + ntToStr(nG_TOTAL_WAREHOUSE_ID);
              Result := NO_AVAILABLE_QUERY_COMP + '  公司別=' + ntToStr(nG_TOTAL_WAREHOUSE_ID);
              Exit;
            end
            else
            begin
...
begin
{
    ...
    begin
        ...
        begin
            for ii:=0 to L_NodeList.length -1 do
                showmessage('公司代碼:' + L_NodeList.item[ii].text);
        end;
    end;
}    
end;
