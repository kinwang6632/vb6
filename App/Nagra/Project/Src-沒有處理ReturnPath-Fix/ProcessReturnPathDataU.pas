...
type
  ...
  public
    ...
    function Write(I_Buf: Pointer; I_Count: Integer;
...
begin
    ...
    try
        ...
        frmMain.G_ReturnPathWStream.Write( L_DeviceData, nL_Len + 2 );
...
begin
  AByte := 0;
  while ( AByte < I_Count ) do
  try
    AByte := AByte + I_WStream.Write(
      Increment( I_Buf, AByte )^,  I_Count - AByte );
  except
    frmMain.G_ReturnPathSvr.buildConnection(frmMain.ReturnPathClntSocket,
      frmMain.G_ReturnPathWStream);
