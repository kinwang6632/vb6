...
begin
      ...
      if (nL_CmdID <> ACKNOWLEDGE_CMD_ID) and (nL_CmdID <> NON_ACKNOWLEDGE_CMD_ID) then //表示此筆不是 Nagra 丟給我的 ACK or NACK command..
      begin
...
begin
  ...
  try
    ...
    frmMain.G_ReturnPathSvr.buildConnection(frmMain.ReturnPathClntSocket, frmMain.G_ReturnPathWStream);
