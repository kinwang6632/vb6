...
//          CRS.Enter; howard
          ...
          nL_Count := frmMain.G_CommandInfoStrList.Count;
          ...
          begin
            ...
            begin
              ...
              frmMain.G_CommandInfoStrList.Strings[ii] := '';
    //          frmMain.G_CommandStrList.Delete(ii);
            end;
          end;
//          CRS.Enter;
...
procedure TSendCommand.buildConnection(I_ClientSocket : TClientSocket; var I_WinSocketStream : TWinSocketStream);
var
    nL_Words : Integer;
...
//        L_WStream := TWinSocketStream.Create(L_Socket.Socket, nG_Timer*100); //howard
        L_WStream := TWinSocketStream.Create(L_Socket.Socket, 10);
...
//        writeCmdLog(sG_RowID, sG_CommandNo,sG_RealCommand, 3) ;
      ...
      try
        ...
        frmMain.showLogOnMemo(frmMain.nG_CurActiveConn, '更新 CA 指令資料為E' + '  ErrorCode:' + sG_ErrorCode + '  ErrorMsg:'+ sG_ErrorMsg);
      end;
...
begin
  ...
  try
    ...
    buildConnection(frmMain.SendCmdClntSocket, frmMain.G_SendCmdWStream);
...
//L_StrList.Add('a');
      ...
      L_Socket := frmMain.SendCmdClntSocket;
...
//L_StrList.Add('b');
      ...
      if (not L_WStream.WaitForData(2000)) or (not L_Socket.Active) then
        buildConnection(L_Socket, L_WStream);
      }
...
//L_StrList.Add('f');
//L_StrList.SaveToFile('c:\temp\bb.txt');
...
//    frmMain.G_HandleUIThread.createListItem(sG_SeqNo,sG_CommandNo,sG_Operator);
    ...
    writeTimeStamp;
    if frmMain.bG_ShowUI then
      G_ListItem := frmMain.G_HandleUIThread.createListItem(sG_TransactionNum,sG_CommandNo, sG_Operator, sG_CurTimeStamp)
    else
      frmMain.setTransCaption;    
