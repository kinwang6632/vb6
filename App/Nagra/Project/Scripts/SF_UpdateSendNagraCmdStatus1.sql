CREATE OR REPLACE FUNCTION SF_UpdateSendNagraCmdStatus1
...
EXEC :ReturnNo := SF_UpdateSendNagraCmdStatus1('E','err-code','err-msg','009000002','0003',:RetCode ,:RetMsg)
EXEC :ReturnNo := SF_UpdateSendNagraCmdStatus1('C','','','009000002','0003',:RetCode ,:RetMsg)
EXEC :ReturnNo := SF_UpdateSendNagraCmdStatus1('P','1,2,3','','','',:RetCode ,:RetMsg)
PRINT ReturnNo
PRINT RetCode
PRINT RetMsg
  ...
  檔名: SF_UpdateSendNagraCmdStatus1.sql
