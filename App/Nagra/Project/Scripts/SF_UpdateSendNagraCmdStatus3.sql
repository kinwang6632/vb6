CREATE OR REPLACE FUNCTION SF_UpdateSendNagraCmdStatus3
...
EXEC :ReturnNo := SF_UpdateSendNagraCmdStatus3('E','err-code','err-msg','009000002','0003',:RetCode ,:RetMsg)
EXEC :ReturnNo := SF_UpdateSendNagraCmdStatus3('C','','','009000002','0003',:RetCode ,:RetMsg)
EXEC :ReturnNo := SF_UpdateSendNagraCmdStatus3('P','1,2,3','','009000002','0003',:RetCode ,:RetMsg)
PRINT ReturnNo
PRINT RetCode
PRINT RetMsg
  ...
  檔名: SF_UpdateSendNagraCmdStatus3.sql
