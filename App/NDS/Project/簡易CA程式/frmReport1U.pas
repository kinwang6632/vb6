...
begin
    ...
    begin
      ...
      begin
        ...
        sI_Cond := ' SUBSCRIBERID=' + STR_SEP + Trim(edtSubscruberID.Text) + STR_SEP + ' ';
    end
    else if RadioGroup1.ItemIndex = 1 then
    begin
      ...
      begin
        ...
        sI_Cond := ' ICCNO=' + STR_SEP + Trim(edtIccNo.Text) + STR_SEP + ' ';
    end
    else
    begin
      ...
      sI_Cond := ' UPDTIME >=''' +  sL_StartDate +
                 ''' AND UPDTIME <=''' + sL_EndDate + '''';
    end;
...
begin
    ...
    begin
      sL_SQL := 'select * from SimpleCaLog where ' + sL_Cond + ' order by UPDTIME ,ACTION';
