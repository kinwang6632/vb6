...
//    POPULATION_ID_LENGTH = 2;    
    INT_POPULATION_ID_LENGTH = 5;
    HEX_POPULATION_ID_LENGTH = 4;    
...
//    PROCESSING_DATE_LENGTH = 14;
    ...
    INT_SERVICE_ID_LENGTH = 5;
    HEX_SERVICE_ID_LENGTH = 4;

    HEX_OPPV_NUM_LENGTH = 4;
    OPPV_EXPIRATION_DATE_LENGTH = 8;

    HEX_SLOT_NUM_LENGTH = 2;
    HEX_SERIES_ID_LENGTH = 4;
    HEX_LIMIT_LENGTH = 4;
    HEX_THRESHOLD_LENGTH = 4;
    HEX_MAX_NUM_OF_SLOT_LENGTH = 2;
...
//以上是 Ca Dispatcher 傳給 CaProcessor 的參數長度變數
    ...
    BAD_CLIENT_DATA_FORMAT = -984;



    SUBSCRIBER_DATA_SEP_FLAG = '#';
    SUBSCRIBER_INFO_SEP_FLAG = '~';
    
    CURRENCY_LENGTH = 4;
    PERSONAL_REGION_LENGTH_LENGTH = 2;
    EMAIL_MSG_ID_LENGTH = 4;
    REPORTBACK_TIME_LENGTH = 6;    
    ERROR_CODE_LENGTH = 4;
    DATE_LENGTH = 8;
    RESPONSE_636_LENGTH = 10;
    RESPONSE_633_LENGTH = 102;
    RESPONSE_632_LENGTH = 3;
    RESPONSE_634_LENGTH = 5;
    RESPONSE_639_LENGTH = 5;    
    
    ERROR_MSG_FILE_NAME = 'NDS_ERROR_MSG.txt';
    ...
    NOTES_FIELD_FORMAT_ERROR_MSG = 'SEND_NDS 之 Notes 欄位格式錯誤...';
    ...
    //dtmMain.runSQL是 SELECT或是其他
    SELECT_MODE = 1;
    IUD_MODE = 2;

    NO_AVAILABLE_QUERY_COMP = '無法取得適當的元件reference.以致無法讀取資料庫之資料.';

    //fillStringLength 是字串或是數字
    SPACE_STR = '1';
    ZERO_STR = '2';

    SIMPLE_CA_CONNECT = 'S_CA_CONNECT';
    SIMPLE_CA_DISCONNECT = 'S_CA_DISCONNECT';
    SIMPLE_CA_CONNECTION_OK = 'S_CA_CONNECTION_OK';

    ROOT_NODE_COMMAND_NAME = 'CA_DATA';
    ROOT_NODE_COMMAND_VALUE = '';

    ROOT_NODE_RESPONSE_NAME = 'CA_RESPONSE';
    ROOT_NODE_RESPONSE_VALUE = '';

    ROOT_NODE_INFO_NAME = 'INFO';
    ROOT_NODE_INFO_VALUE = '';
{
