...
// File generated on 2001/11/29 ¤W¤È 10:47:10 from Type Library described below.
...
{$ENDIF}
  ...
  protected
    ...
    procedure _Set_documentElement(const DOMElement: IXMLDOMElement);
  ...
  public
    ...
    function  createTextNode(const data: WideString): IXMLDOMCharacterData;
...
begin
  Result := DefaultInterface.doctype;
end;

function  TDOMDocument.Get_implementation_: IXMLDOMImplementation;
begin
  Result := DefaultInterface.implementation_;
end;
...
procedure TDOMDocument._Set_documentElement(const DOMElement: IXMLDOMElement);
  { Warning: The property documentElement has a setter and a getter whose
...
begin
  ...
  InterfaceVariant.documentElement := DOMElement;
end;
...
begin
  DefaultInterface.ondataavailable := Param1;
end;

procedure TDOMDocument.Set_ontransformnode(Param1: OleVariant);
begin
  DefaultInterface.ontransformnode := Param1;
end;
...
function  TDOMDocument.createTextNode(const data: WideString): IXMLDOMCharacterData;
begin
...
procedure TDOMDocumentProperties._Set_documentElement(const DOMElement: IXMLDOMElement);
  { Warning: The property documentElement has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
procedure TDOMFreeThreadedDocument._Set_documentElement(const DOMElement: IXMLDOMElement);
  { Warning: The property documentElement has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
function  TDOMFreeThreadedDocument.createTextNode(const data: WideString): IXMLDOMCharacterData;
begin
  Result := DefaultInterface.createTextNode(data);
end;
...
procedure TDOMFreeThreadedDocumentProperties._Set_documentElement(const DOMElement: IXMLDOMElement);
  { Warning: The property documentElement has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
begin
  DefaultInterface.XMLDocument := ppDoc;
end;
...
begin
  DefaultInterface.JavaDSOCompatible := fJavaDSOCompatible;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.charset;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.async;
end;

function  TXMLDocument.Set_async(pf: WordBool): HResult;
  { Warning: The property async has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
  InterfaceVariant: OleVariant;
...
procedure Register;
begin
  RegisterComponents(dtlServerPage, [TDOMDocument, TDOMFreeThreadedDocument, TXMLHTTPRequest, TXMLDSOControl, 
    TXMLDocument]);
end;
