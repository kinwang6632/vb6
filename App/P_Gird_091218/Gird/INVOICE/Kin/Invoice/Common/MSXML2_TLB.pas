...
// File generated on 91/4/15 14:51:09 from Type Library described below.
...
// *********************************************************************//
  IVBSAXXMLFilter = interface(IDispatch)
    ...
    property parent: IVBSAXXMLReader read Get_parent;
  end;
...
// *********************************************************************//
  IXMLDOMSelection = interface(IXMLDOMNodeList)
    ...
    property context: IXMLDOMNode read Get_context;
  end;
...
procedure Register;
begin
  RegisterComponents(dtlServerPage, [TDOMDocument, TDOMDocument26, TDOMDocument30, TFreeThreadedDOMDocument, 
