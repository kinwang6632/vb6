...
/*
	...
	Modify By Kin     : 2009.12.18  問題集5358 如果設定顯示設備, 將每一筆的設備Keep起來,到最後寫入INV007.Memo1
*/
...
begin
    ...
    begin
       insert into inv007 ( identifyid1, identifyid2, checkno, invid, canmodify, invdate, chargedate,
           ...
           maininvamount, invuseid, invusedesc,Memo1 )
    ...
    begin
       ...
       select p_IdentifyID1, p_IdentifyID2, b.invid, b.billid, b.billiditemno, b.seq,
		  ...
		  b.saleamount, nvl( b.LinkToMis, 'Y' ), b.facisno
