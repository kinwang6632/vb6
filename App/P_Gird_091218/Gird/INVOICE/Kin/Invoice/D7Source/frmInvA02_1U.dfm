object frmInvA02_1: TfrmInvA02_1
  Left = 289
  Top = 106
  ActiveControl = dbgChargeInfo33
    ...
    object dbgMdCustomer: TDBGrid
      ...
      Columns = <
        item
          ...
          Title.Caption = #37109#23492#22320#22336
          Width = 131
          Visible = True
        end
        item
        ...
        item
          ...
          Title.Caption = #30332#31080#22320#22336
          Width = 227
          Visible = True
        end
        item
          ...
          Title.Caption = #35037#27231#22320#22336
          Width = 227
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'ZIPCODE'
          Title.Caption = #37109#36958#21312#34399
          Width = 80
          Visible = True
        end
        item
        ...
        item
          ...
          Title.Caption = #30332#31080#25260#38957#27969#27700#34399
          Width = 120
          Visible = True
        end>
    end
  ...
  object Panel2: TPanel
    ...
    BevelOuter = bvNone
    TabOrder = 2
    object dbgChargeInfo33: TDBGrid
      Left = 0
      Top = 27
      Width = 659
      Height = 143
      ...
      Columns = <
        ...
        item
          ...
          Title.Caption = #25033#25910#26085
          Width = 100
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'SHOULDAMT'
          Title.Caption = #25033#25910#37329#38989
          Width = 89
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'REALDATE'
          Title.Caption = #23526#25910#26085
          Width = 100
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'REALAMT'
          Title.Caption = #23526#25910#37329#38989
          Width = 102
          Visible = True
        end
        item
          ...
          Title.Caption = #25910#36027#26399#25976
          Width = 88
          Visible = True
        end
        item
          ...
          Title.Caption = #26377#25928#36215#22987#26085#26399
          Width = 103
          Visible = True
        end
        item
          ...
          Title.Caption = #26377#25928#25130#27490#26085#26399
          Width = 104
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'CLCTNAME'
          Title.Caption = #25910#36027#20154#21729#22995#21517
          Width = 107
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'STNAME'
          Title.Caption = #30701#25910#21407#22240
          Width = 93
          Visible = True
        end
        item
        ...
        item
          Expanded = False
          FieldName = 'RATE1'
          Title.Caption = #31237#29575#19968
          Width = 70
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'ACCOUNTNO'
          Title.Caption = #25187#24115#24115#34399
          Width = 109
          Visible = True
        end
        item
  ...
  object Panel4: TPanel
    ...
    BevelOuter = bvNone
    TabOrder = 3
    object dbgChargeInfo34: TDBGrid
      Left = 0
      Top = 32
      Width = 659
      Height = 196
  ...
  object dsrChargeInfo33: TDataSource
    DataSet = dtmSO.adoChargeInfo33
    Left = 212
    Top = 256
  end
  object dsrChargeInfo34: TDataSource
    DataSet = dtmSO.adoChargeInfo34
    Left = 208
    Top = 444
  end
  object dsrMdCustomer: TDataSource
    DataSet = dtmSO.adoMdCustomer
    Left = 208
    Top = 92
  end
end
