...
type
  ...
  private
    ...
    function DoInsertInv014(var aErrMsg: String): Boolean;
...
//  aDataSet := dtmMain.adoComm;
  ...
  begin
    ...
    aErrMsg := EmptyStr;
    try
      if not DoInsertInv014( aErrMsg ) then
      begin
...
function TfrmInvB04.DoInsertInv014(var aErrMsg: String): Boolean;
var
  ...
  try
    ...
    begin
      ...
      aWriter.FieldByName( 'InvAmount' ).AsInteger := aWriter.FieldByName( 'InvAmount' ).AsInteger +
        cdsSO034.FieldByName( 'RealAmt' ).AsInteger;
    ...
    begin
      ...
      aWriter.SQL.Text := Format(
        ...
        ' ''%s'',''%s'' )                                      ' ,
        [ cdsSO034.FieldByName('SERVICETYPE').AsString,
          cdsSO034.FieldByName('BillNO').AsString,
          cdsSO034.FieldByName('ITEM').AsString,
          cdsSO034.FieldByName('CitemCode').AsString,
          cdsSO034.FieldByName('CitemName').AsString,
          cdsSO034.FieldByName('PTCode').AsString,
          cdsSO034.FieldByName('PTName').AsString,
          cdsSO034.FieldByName('RealAMT').AsInteger,
          FormatDateTime('YYYYMMDD HHMMSS',FsysDate),
          dtmMain.getLoginUser,
          aAllowanceNo ] );
...
begin
  ...
  begin
    FInv005.FieldDefs.Add( 'ITEMID', ftInteger );
