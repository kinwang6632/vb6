...
var
  frmMultiSelectX: TfrmMultiSelectX;
...
procedure TfrmMultiSelectX.FormCreate(Sender: TObject);
begin
...
procedure TfrmMultiSelectX.FormShow(Sender: TObject);
begin
...
procedure TfrmMultiSelectX.FormDestroy(Sender: TObject);
begin
  ClearDataItem;
...
procedure TfrmMultiSelectX.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmMultiSelectX.SetDataSet(const AValue: TClientDataSet);
begin
  FDataSet.Data := Null;
...
procedure TfrmMultiSelectX.SetKeyFields(const Value: String);
begin
...
procedure TfrmMultiSelectX.SetKeyValues(const Value: String);
begin
...
procedure TfrmMultiSelectX.SetDisplayFields(const Value: String);
var
  aIndex: Integer;
begin
...
procedure TfrmMultiSelectX.SetResultFields(const Value: String);
begin
...
procedure TfrmMultiSelectX.ExtractFieldsToList(aSource: String; aList: TStringList);
var
  aField: String;
begin
  aList.Clear;
...
procedure TfrmMultiSelectX.CreateDisplayColumns;
var
  aColumn: TListColumn;
...
procedure TfrmMultiSelectX.FreeupBookmark;
var
  aIndex: Integer;
begin
...
procedure TfrmMultiSelectX.AddDataItem;
var
  aItem: TListItem;
...
procedure TfrmMultiSelectX.ClearDataItem;
begin
  FreeupBookmark;
  ListView.Clear;
end;
...
procedure TfrmMultiSelectX.actSelectAllExecute(Sender: TObject);
var
  aIndex: Integer;
begin
  for aIndex := 0 to ListView.Items.Count - 1 do
...
procedure TfrmMultiSelectX.actClearExecute(Sender: TObject);
var
  aIndex: Integer;
begin
  for aIndex := 0 to ListView.Items.Count - 1 do
...
procedure TfrmMultiSelectX.actConfirmExecute(Sender: TObject);
begin
  SetSelectedResult;
...
procedure TfrmMultiSelectX.actCancelExecute(Sender: TObject);
begin
...
procedure TfrmMultiSelectX.SetSelectedResult;
var
...
procedure TfrmMultiSelectX.edtTextPropertiesChange(Sender: TObject);
begin
...
procedure TfrmMultiSelectX.chklShowSelectedPropertiesChange(Sender: TObject);
var
  aCounter: Integer;
begin
...
procedure TfrmMultiSelectX.ListViewDblClick(Sender: TObject);
var
  aItem: TListItem;
begin
...
procedure TfrmMultiSelectX.btnNextClick(Sender: TObject);
var
...
procedure TfrmMultiSelectX.btnPriorClick(Sender: TObject);
var
  aIndex, aSearchCol: Integer;
begin
  aSearchCol := 1;
