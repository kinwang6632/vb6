...
procedure TrptReport3.QRLabel10Print(sender: TObject; var Value: String);
begin
    Value := sG_CompName;
end;

procedure TrptReport3.QRLabel11Print(sender: TObject; var Value: String);
begin
    Value := sG_ReportGetPaperDateStr;
end;

procedure TrptReport3.QRLabel12Print(sender: TObject; var Value: String);
begin
    Value := sG_ReportPaperNumStr;
end;

procedure TrptReport3.QRLabel13Print(sender: TObject; var Value: String);
begin
    Value := sG_GetPaperEmpsName;
end;

procedure TrptReport3.QRLabel14Print(sender: TObject; var Value: String);
begin
    Value := sG_Operator;
end;

procedure TrptReport3.QRLabel15Print(sender: TObject; var Value: String);
begin
    Value := TUdateTime.CDateStr(date,9);
end;

procedure TrptReport3.QRLabel20Print(sender: TObject; var Value: String);
begin
    Value := self.DataSet.fieldByName('EMPNO').AsString; 
end;

procedure TrptReport3.QRLabel21Print(sender: TObject; var Value: String);
var
...
procedure TrptReport3.QRLabel22Print(sender: TObject; var Value: String);
begin
    Value := self.DataSet.fieldByName('EMPNAME').AsString;
end;

procedure TrptReport3.QRLabel28Print(sender: TObject; var Value: String);
begin
...
procedure TrptReport3.QRDBText7Print(sender: TObject; var Value: String);
begin
...
procedure TrptReport3.QuickRepPreview(Sender: TObject);
var
