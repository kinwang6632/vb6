...
begin
    FscExcelExport1.Dataset := G_ActiveDataSet;
    FscExcelExport1.ExportDataset(true);
    FscExcelExport1.ExcelVisible := true;
end;


procedure TfrmRptPreView.FormCreate(Sender: TObject);
begin
  FscExcelExport1 := TscExcelExport.Create( nil );
end;

procedure TfrmRptPreView.FormDestroy(Sender: TObject);
begin
  FscExcelExport1.Free;
end;
