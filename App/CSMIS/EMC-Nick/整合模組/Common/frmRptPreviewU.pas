...
type
  ...
  public
    ...
    sG_ShowDetail,sG_CompCode,sG_BelongYM,sG_RptName,sG_RptCompName : String;
    sG_RptBelongYM,sG_RptRealDate,sG_ShowType : String;
...
//uses dtmMain1U, frmShowRptSQLU;
uses  dtmMain1U, rptSO8B20AU, rptSO8B20B_1U;
...
begin
{
    dtmMain1.deleteCommData(dtmMain1.sG_CompCode,dtmMain1.sG_ComputeYM);
    dtmMain1.applyToDB;
    dtmMain1.transReturnDataCdsIntoDB;
    btnTransData.Enabled := false;
    if self.Report IS TrptSO8B20A then
      TrptSO8B20A(self.Report).bG_LockData := true;
