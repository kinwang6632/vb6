...
const
//二階代碼
  SYS_COMPDBINFO_INI_FILE_NAME = 'CompDBInfo.ini';

//佣金計算
  SYS_INI_FILE_NAME = 'Commission.ini';
  TMP_SYS_INI_FILE_NAME = 'Temp.ini';
  DATA_AREA_HEADER = 'COMP';

  INSERT_NO_DATA_ITEM = true;
  DEFAULT_NO_DATA_ITEM_CODE_VALUE = '0';
  DEFAULT_NO_DATA_ITEM_DESC_VALUE = '無';
...
type
  TUCommonFun = class
    public
      ...
      class procedure AddObjectToComboBox(I_StrList:TStrings; I_DS:TDataSet; bI_InsertAllDataItem:boolean;sI_CodeName,sI_DescName : String);overload;
      class procedure AddObjectToComboBox(I_StrList:TStrings; I_DS:TDataSet; bI_InsertAllDataItem, bI_CombineCD:boolean;sI_CodeName,sI_DescName : String);overload;
...
class procedure TUCommonFun.AddObjectToComboBox(I_StrList: TStrings;
  I_DS: TDataSet; bI_InsertAllDataItem: boolean;sI_CodeName,sI_DescName : String);
var
    L_Obj : TNormalObj;
...
begin
    ...
    begin
      ...
      begin
        ...
        sL_CodeNo := DEFAULT_NO_DATA_ITEM_CODE_VALUE;
        sL_Desc := DEFAULT_NO_DATA_ITEM_DESC_VALUE;
      ...
      while not eof do
      begin
        sL_CodeNo := FieldByName(sI_CodeName).AsString;
        sL_Desc := FieldByName(sI_DescName).AsString;
        L_Obj := TNormalObj.Create;
        L_Obj.s_Code := sL_CodeNo;
        L_Obj.s_Desc := sL_Desc;
        I_StrList.AddObject(sL_CodeNo+CODE_VALUE_SEP+sL_Desc,L_Obj);
...
class procedure TUCommonFun.AddObjectToComboBox(I_StrList: TStrings;
  I_DS: TDataSet; bI_InsertAllDataItem, bI_CombineCD: boolean;sI_CodeName,sI_DescName : String);
var
    L_Obj : TNormalObj;
    sL_CodeNo, sL_Desc : String;
begin
