object dtmMain3: TdtmMain3
  ...
  object qrySo126: TADOQuery
    ...
    object qrySo126CLEARDATE: TDateTimeField
      DisplayLabel = #28165#38500#26085#26399
      FieldName = 'CLEARDATE'
    end
  ...
  object qryReport5: TADOQuery
    Connection = frmMainMenu.ADOConnection1
    Parameters = <>
    SQL.Strings = (
      
        'select SEQ, SPAPERNUM, EPAPERNUM, TOTALPAPERCOUNT, EMPNAME,GETPA' +
        'PERDATE, NOTES, OPERATOR, UPDTIME from SO129 where seq<1 ')
    Left = 32
    Top = 184
    object qryReport5SEQ: TBCDField
      FieldName = 'SEQ'
      Precision = 10
      Size = 0
    end
    object qryReport5SPAPERNUM: TStringField
      FieldName = 'SPAPERNUM'
      Size = 15
    end
    object qryReport5EPAPERNUM: TStringField
      FieldName = 'EPAPERNUM'
      Size = 15
    end
    object qryReport5TOTALPAPERCOUNT: TIntegerField
      FieldName = 'TOTALPAPERCOUNT'
    end
    object qryReport5EMPNAME: TStringField
      FieldName = 'EMPNAME'
      Size = 30
    end
    object qryReport5GETPAPERDATE: TDateTimeField
      FieldName = 'GETPAPERDATE'
    end
    object qryReport5NOTES: TStringField
      FieldName = 'NOTES'
      Size = 200
    end
    object qryReport5OPERATOR: TStringField
      FieldName = 'OPERATOR'
    end
    object qryReport5UPDTIME: TStringField
      FieldName = 'UPDTIME'
    end
  end
  object rtpSO8C10: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 72
    Top = 132
