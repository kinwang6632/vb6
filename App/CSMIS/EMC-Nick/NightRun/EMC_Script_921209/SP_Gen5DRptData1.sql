...
exception
  when others then
    ...
    v_RetCode := -98;
    DBMS_OUTPUT.PUT_LINE('x_ClassCode='||x_ClassCode||',x_Period='||x_Period||',x_CustCount='||x_CustCount||',x_ClctDate='||x_ClctDate);
    DBMS_OUTPUT.PUT_LINE('z_MonthIndex='||z_MonthIndex);
end;
