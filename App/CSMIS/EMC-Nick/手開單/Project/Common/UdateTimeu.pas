...
Type
  ...
  public
    ...
    class function GetPureDateTimeStr(dI_Date:TDate):String;
    class function GetPureChineseDateTimeStr(dI_Date:TDate):String;        
    ...
    class function CDateStr(aDt:TDateTime; iLen:Integer):string; //將西元日期,轉為中華民國日期字串
    class function CDate2Date(asCDate:string):TDateTime; //將中華民國日期字串轉為西元日期字串
...
class function TUdateTime.GetPureDateTimeStr(dI_Date: TDate): String;
var
    wL_Year,wL_Month,wL_Day : Word;
...
begin
     ...
     Result := Format('%.4d/%.2d/%.2d %.2d:%.2d:%.2d',[wL_Year,wL_Month,wL_Day, wL_Hour,wL_Min,wL_Sec]);
end;

class function TUdateTime.GetPureChineseDateTimeStr(
  dI_Date: TDate): String;
var
    wL_Year,wL_Month,wL_Day : Word;
    wL_Hour,wL_Min,wL_Sec, wL_MSec : word;
begin
     ...
     Result := Format('%.3d/%.2d/%.2d %.2d:%.2d:%.2d',[wL_Year-1911,wL_Month,wL_Day, wL_Hour,wL_Min,wL_Sec]);
end;
