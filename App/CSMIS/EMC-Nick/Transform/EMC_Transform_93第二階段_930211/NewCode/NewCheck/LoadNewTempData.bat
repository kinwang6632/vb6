...
rem 22. Load CD041之新代碼資料: CD041_NEWTEMP
sqlldr userid=emcct/emcct@mis control=CD041_NEWTEMP.ctl  log=CD041_NEWTEMP.log

rem 23. Load CD049之新代碼資料: CD049_NEWTEMP
sqlldr userid=emcct/emcct@mis control=CD049_NEWTEMP.ctl  log=CD049_NEWTEMP.log

rem 24. Load CD051之新代碼資料: CD051_NEWTEMP
sqlldr userid=emcct/emcct@mis control=CD051_NEWTEMP.ctl  log=CD051_NEWTEMP.log

rem 25. Load CD055之新代碼資料: CD055_NEWTEMP
sqlldr userid=emcct/emcct@mis control=CD055_NEWTEMP.ctl  log=CD055_NEWTEMP.log

rem 26. Load CD059之新代碼資料: CD059_NEWTEMP
