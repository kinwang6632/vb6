Prompt ***** 93.01.27 建立新舊代碼對照 Table 及 備份舊代碼檔 *****
--*******************************************************************
--*******************************************************************
...
--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Prompt 建立-供電戶費用公式代碼檔(CD041)之新舊代碼對照 Table: CD041_Map
DROP TABLE CD041_Map CASCADE CONSTRAINT;
create table CD041_Map (
	NewCode number(3),
	NewName varchar2(20),
	OldCode number(3),
	OldName varchar2(20),
...
Prompt ***** 備份 CD041 舊代碼 Table *****
drop table CD041_Old cascade constraint;
create table CD041_Old as (select * from CD041);
