rem ***** 93.01.27 建立新舊代碼對照 Table 及 備份舊代碼檔 *****
...
rem 22. Load CD041之新舊對照表: CD041_MAP
sqlldr userid=emcct/emcct@mis control=CD041_MAP.ctl  log=CD041_MAP.log


rem 23. Load CD049之新舊對照表: CD049_MAP
sqlldr userid=emcct/emcct@mis control=CD049_MAP.ctl  log=CD049_MAP.log


rem 24. Load CD051之新舊對照表: CD051_MAP
sqlldr userid=emcct/emcct@mis control=CD051_MAP.ctl  log=CD051_MAP.log


rem 25. Load CD055之新舊對照表: CD055_MAP
sqlldr userid=emcct/emcct@mis control=CD055_MAP.ctl  log=CD055_MAP.log


rem 26. Load CD059之新舊對照表: CD059_MAP
