...
/*
    東森代碼轉檔
    檔名: SP_Transform_2.sql
    轉換資料檔CD019A~SO034
    
    By: Jackal   Date: 2004.01.30
    
  	2004.02.17 改: 1.CD005,CD006,CD007,CD008C,CD011A,CD019CD004,CD022,CD022CD019及CD059
                     等代碼檔,若有需要被轉換的非必要欄位,一併改由新代碼Load方式新增.
                   2.因CD041代碼檔決定不轉,故資料檔SO020亦不用置換
                   3.CD019A,CD019B,CD019SO017,CD022A,CD027A,CD027B,CD027C及CD027D等代碼檔當作資料檔轉換
*/
...
*/
  ...
  IF v_TempCounts=0 THEN --轉代碼前先確定沒有轉過
    ...
    FOR crCD019A in ccCD019A loop
      ...
      EXCEPTION
        WHEN others THEN
          ...
          INSERT INTO TransFormLog_2(TYPE,DESCRIPTION,TABLENAME)
            VALUES(C_UpdDataErrorType,'UPDATE 資料檔CD019A有誤  CodeNo: '||crCD019A.CodeNo||' CitemCode: '||crCD019A.CitemCode,'CD019A');
    ...
    INSERT INTO TransFormLog_1(TABLENAME,DESCRIPTION,OKCOUNTS,ERRORCOUNTS,STARTTIME,STOPTIME,ALLTIME)
      VALUES('CD019A','資料檔CD019A代碼轉換完成',v_OKCounts,v_ErrorCounts,v_StartTime,SysDate,v_AllTiem);
...
--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  IF v_TempCounts=0 THEN --轉代碼前先確定沒有轉過
    ...
    FOR crCD019B in ccCD019B loop
      ...
      EXCEPTION
        WHEN others THEN
          ...
          INSERT INTO TransFormLog_2(TYPE,DESCRIPTION,TABLENAME)
            VALUES(C_UpdDataErrorType,'UPDATE 資料檔CD019B有誤  CitemCode: '||crCD019B.CitemCode,'CD019B');
    ...
    INSERT INTO TransFormLog_1(TABLENAME,DESCRIPTION,OKCOUNTS,ERRORCOUNTS,STARTTIME,STOPTIME,ALLTIME)
      VALUES('CD019B','資料檔CD019B代碼轉換完成',v_OKCounts,v_ErrorCounts,v_StartTime,SysDate,v_AllTiem);
...
--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  IF v_TempCounts=0 THEN --轉代碼前先確定沒有轉過
    ...
    FOR crCD019SO017 in ccCD019SO017 loop
      ...
      EXCEPTION
        WHEN others THEN
          ...
          INSERT INTO TransFormLog_2(TYPE,DESCRIPTION,TABLENAME)
            VALUES(C_UpdDataErrorType,'UPDATE 資料檔CD019SO017有誤  CitemCode: '||crCD019SO017.CitemCode,'CD019SO017');
    ...
    INSERT INTO TransFormLog_1(TABLENAME,DESCRIPTION,OKCOUNTS,ERRORCOUNTS,STARTTIME,STOPTIME,ALLTIME)
      VALUES('CD019SO017','資料檔CD019SO017代碼轉換完成',v_OKCounts,v_ErrorCounts,v_StartTime,SysDate,v_AllTiem);
...
--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  IF v_TempCounts=0 THEN --轉代碼前先確定沒有轉過
    ...
    FOR crCD022A in ccCD022A loop
      ...
      EXCEPTION
        WHEN others THEN
          ...
          INSERT INTO TransFormLog_2(TYPE,DESCRIPTION,TABLENAME)
            VALUES(C_UpdDataErrorType,'UPDATE 資料檔CD022A有誤  CitemCode: '||crCD022A.CitemCode||' CitemCode: '||crCD022A.FaciCode,'CD022A');
    ...
    INSERT INTO TransFormLog_1(TABLENAME,DESCRIPTION,OKCOUNTS,ERRORCOUNTS,STARTTIME,STOPTIME,ALLTIME)
      VALUES('CD022A','資料檔CD022A代碼轉換完成',v_OKCounts,v_ErrorCounts,v_StartTime,SysDate,v_AllTiem);
...
--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  IF v_TempCounts=0 THEN --轉代碼前先確定沒有轉過
    ...
    FOR crCD027A in ccCD027A loop
      ...
      EXCEPTION
        WHEN others THEN
          ...
          INSERT INTO TransFormLog_2(TYPE,DESCRIPTION,TABLENAME)
            VALUES(C_UpdDataErrorType,'UPDATE 資料檔CD027A有誤  PackageNo: '||crCD027A.PackageNo||' CitemCode: '||crCD027A.CitemCode,'CD027A');
    ...
    INSERT INTO TransFormLog_1(TABLENAME,DESCRIPTION,OKCOUNTS,ERRORCOUNTS,STARTTIME,STOPTIME,ALLTIME)
      VALUES('CD027A','資料檔CD027A代碼轉換完成',v_OKCounts,v_ErrorCounts,v_StartTime,SysDate,v_AllTiem);
...
--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  IF v_TempCounts=0 THEN --轉代碼前先確定沒有轉過
    ...
    FOR crCD027B in ccCD027B loop
      ...
      EXCEPTION
        WHEN others THEN
          ...
          INSERT INTO TransFormLog_2(TYPE,DESCRIPTION,TABLENAME)
            VALUES(C_UpdDataErrorType,'UPDATE 資料檔CD027B有誤  PackageNo: '||crCD027B.PackageNo||' CodeNo: '||crCD027B.CodeNo,'CD027B');
    ...
    INSERT INTO TransFormLog_1(TABLENAME,DESCRIPTION,OKCOUNTS,ERRORCOUNTS,STARTTIME,STOPTIME,ALLTIME)
      VALUES('CD027B','資料檔CD027B代碼轉換完成',v_OKCounts,v_ErrorCounts,v_StartTime,SysDate,v_AllTiem);
...
--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  IF v_TempCounts=0 THEN --轉代碼前先確定沒有轉過
    ...
    FOR crCD027C in ccCD027C loop
      ...
      EXCEPTION
        WHEN others THEN
          ...
          INSERT INTO TransFormLog_2(TYPE,DESCRIPTION,TABLENAME)
            VALUES(C_UpdDataErrorType,'UPDATE 資料檔CD027C有誤  PackageNo: '||crCD027C.PackageNo||' CodeNo: '||crCD027C.CodeNo,'CD027C');
    ...
    INSERT INTO TransFormLog_1(TABLENAME,DESCRIPTION,OKCOUNTS,ERRORCOUNTS,STARTTIME,STOPTIME,ALLTIME)
      VALUES('CD027C','資料檔CD027C代碼轉換完成',v_OKCounts,v_ErrorCounts,v_StartTime,SysDate,v_AllTiem);
...
--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  IF v_TempCounts=0 THEN --轉代碼前先確定沒有轉過
    ...
    FOR crCD027D in ccCD027D loop
      ...
      EXCEPTION
        WHEN others THEN
          ...
          INSERT INTO TransFormLog_2(TYPE,DESCRIPTION,TABLENAME)
            VALUES(C_UpdDataErrorType,'UPDATE 資料檔CD027D有誤  PackageNo: '||crCD027D.PackageNo||' CitemCode: '||crCD027D.CitemCode,'CD027D');
    ...
    INSERT INTO TransFormLog_1(TABLENAME,DESCRIPTION,OKCOUNTS,ERRORCOUNTS,STARTTIME,STOPTIME,ALLTIME)
      VALUES('CD027D','資料檔CD027D代碼轉換完成',v_OKCounts,v_ErrorCounts,v_StartTime,SysDate,v_AllTiem);
