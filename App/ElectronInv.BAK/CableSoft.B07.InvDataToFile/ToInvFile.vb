...
Public Class ToInvFile
    ...
    Public Overloads Function WriteINVFile(ByVal aInvType As CableSoft.B07.InvType.InvTypeEnum.INVTYPE) As Boolean
        ...
        Try
            ...
            Dim aUploadType As Boolean = False
            If Not DBNull.Value.Equals(FInvDs.Tables("Inv001").Rows(0).Item("UploadType")) Then
                aUploadType = Integer.Parse(FInvDs.Tables("Inv001").Rows(0).Item("UploadType").ToString) = 1
            End If
            Select Case aInvType
                Case InvTypeEnum.INVTYPE.OnlyInvNum
    ...
    Public Function WriteA0401(ByVal aUploadType As Integer) As Boolean
        ...
        Dim aFilePath As String = CableSoft.B07.SystemIO.Invoice.GetINVPathName(InvArgument.GetConnect,
    ...
    Private Overloads Function WriteE0402() As Boolean
        ...
        Try
            For i As Int32 = 0 To aTblINV099.Rows.Count - 1
                rowInv001 = FInvDs.Tables("INV001").Select("COMPID='" & aTblINV099.Rows(i)("COMPID") & "'").GetValue(0)
                _TotalCount += 1
                dtXml.Rows.Clear()
                Dim rwNew As DataRow = dtXml.NewRow
                rwNew.ItemArray = aTblINV099.Rows(i).ItemArray
                dtXml.Rows.Add(rwNew)
                WriteToXml(aFilePath, dtXml, rowInv001, InvTypeEnum.InvFileType.E0402)
            Next
